...
export function readProtoOAApplicationAuthReq(pbf, end) {
    return pbf.readFields(readProtoOAApplicationAuthReqField, {payloadType: 2100, clientId: "", clientSecret: ""}, end);
}
function readProtoOAApplicationAuthReqField(tag, obj, pbf) {
...
export function writeProtoOAApplicationAuthReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2100) pbf.writeVarintField(1, obj.payloadType);
    if (obj.clientId) pbf.writeStringField(2, obj.clientId);
    if (obj.clientSecret) pbf.writeStringField(3, obj.clientSecret);
}

export function readProtoOAApplicationAuthRes(pbf, end) {
    return pbf.readFields(readProtoOAApplicationAuthResField, {payloadType: 2101}, end);
}
function readProtoOAApplicationAuthResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
export function writeProtoOAApplicationAuthRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2101) pbf.writeVarintField(1, obj.payloadType);
}

export function readProtoOAAccountAuthReq(pbf, end) {
    return pbf.readFields(readProtoOAAccountAuthReqField, {payloadType: 2102, ctidTraderAccountId: 0, accessToken: ""}, end);
}
function readProtoOAAccountAuthReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.accessToken = pbf.readString();
}
export function writeProtoOAAccountAuthReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2102) pbf.writeVarintField(1, obj.payloadType);
...
export function readProtoOAAccountAuthRes(pbf, end) {
    return pbf.readFields(readProtoOAAccountAuthResField, {payloadType: 2103, ctidTraderAccountId: 0}, end);
}
function readProtoOAAccountAuthResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAccountAuthRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2103) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAErrorRes(pbf, end) {
    return pbf.readFields(readProtoOAErrorResField, {payloadType: 2142, ctidTraderAccountId: 0, errorCode: "", description: "", maintenanceEndTimestamp: 0, retryAfter: 0}, end);
}
function readProtoOAErrorResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAErrorRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2142) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.errorCode) pbf.writeStringField(3, obj.errorCode);
    if (obj.description) pbf.writeStringField(4, obj.description);
    if (obj.maintenanceEndTimestamp) pbf.writeVarintField(5, obj.maintenanceEndTimestamp);
    if (obj.retryAfter) pbf.writeVarintField(6, obj.retryAfter);
}

export function readProtoOAClientDisconnectEvent(pbf, end) {
    return pbf.readFields(readProtoOAClientDisconnectEventField, {payloadType: 2148, reason: ""}, end);
}
function readProtoOAClientDisconnectEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.reason = pbf.readString();
}
export function writeProtoOAClientDisconnectEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2148) pbf.writeVarintField(1, obj.payloadType);
    if (obj.reason) pbf.writeStringField(2, obj.reason);
}

export function readProtoOAAccountsTokenInvalidatedEvent(pbf, end) {
    return pbf.readFields(readProtoOAAccountsTokenInvalidatedEventField, {payloadType: 2147, ctidTraderAccountIds: [], reason: ""}, end);
}
function readProtoOAAccountsTokenInvalidatedEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) pbf.readPackedVarint(obj.ctidTraderAccountIds, true);
    else if (tag === 3) obj.reason = pbf.readString();
}
export function writeProtoOAAccountsTokenInvalidatedEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2147) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountIds) for (const item of obj.ctidTraderAccountIds) pbf.writeVarintField(2, item);
    if (obj.reason) pbf.writeStringField(3, obj.reason);
}

export function readProtoOAVersionReq(pbf, end) {
    return pbf.readFields(readProtoOAVersionReqField, {payloadType: 2104}, end);
}
function readProtoOAVersionReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
export function writeProtoOAVersionReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2104) pbf.writeVarintField(1, obj.payloadType);
}

export function readProtoOAVersionRes(pbf, end) {
    return pbf.readFields(readProtoOAVersionResField, {payloadType: 2105, version: ""}, end);
}
function readProtoOAVersionResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.version = pbf.readString();
}
export function writeProtoOAVersionRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2105) pbf.writeVarintField(1, obj.payloadType);
    if (obj.version) pbf.writeStringField(2, obj.version);
}

export function readProtoOANewOrderReq(pbf, end) {
    return pbf.readFields(readProtoOANewOrderReqField, {payloadType: 2106, ctidTraderAccountId: 0, symbolId: 0, orderType: 0, tradeSide: 0, volume: 0, limitPrice: 0, stopPrice: 0, timeInForce: 2, expirationTimestamp: 0, stopLoss: 0, takeProfit: 0, comment: "", baseSlippagePrice: 0, slippageInPoints: 0, label: "", positionId: 0, clientOrderId: "", relativeStopLoss: 0, relativeTakeProfit: 0, guaranteedStopLoss: false, trailingStopLoss: false, stopTriggerMethod: 1}, end);
}
function readProtoOANewOrderReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOANewOrderReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2106) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    ...
    if (obj.timeInForce != null && obj.timeInForce !== 2) pbf.writeVarintField(9, obj.timeInForce);
    if (obj.expirationTimestamp) pbf.writeVarintField(10, obj.expirationTimestamp);
    ...
    if (obj.stopTriggerMethod != null && obj.stopTriggerMethod !== 1) pbf.writeVarintField(23, obj.stopTriggerMethod);
}

export function readProtoOAExecutionEvent(pbf, end) {
    return pbf.readFields(readProtoOAExecutionEventField, {payloadType: 2126, ctidTraderAccountId: 0, executionType: 0, position: undefined, order: undefined, deal: undefined, bonusDepositWithdraw: undefined, depositWithdraw: undefined, errorCode: "", isServerEvent: false}, end);
}
function readProtoOAExecutionEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.executionType = pbf.readVarint();
    else if (tag === 4) obj.position = readProtoOAPosition(pbf, pbf.readVarint() + pbf.pos);
    else if (tag === 5) obj.order = readProtoOAOrder(pbf, pbf.readVarint() + pbf.pos);
    else if (tag === 6) obj.deal = readProtoOADeal(pbf, pbf.readVarint() + pbf.pos);
    else if (tag === 7) obj.bonusDepositWithdraw = readProtoOABonusDepositWithdraw(pbf, pbf.readVarint() + pbf.pos);
    else if (tag === 8) obj.depositWithdraw = readProtoOADepositWithdraw(pbf, pbf.readVarint() + pbf.pos);
    else if (tag === 9) obj.errorCode = pbf.readString();
    else if (tag === 10) obj.isServerEvent = pbf.readBoolean();
}
export function writeProtoOAExecutionEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2126) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    ...
    if (obj.bonusDepositWithdraw) pbf.writeMessage(7, writeProtoOABonusDepositWithdraw, obj.bonusDepositWithdraw);
    if (obj.depositWithdraw) pbf.writeMessage(8, writeProtoOADepositWithdraw, obj.depositWithdraw);
    if (obj.errorCode) pbf.writeStringField(9, obj.errorCode);
    if (obj.isServerEvent) pbf.writeBooleanField(10, obj.isServerEvent);
}

export function readProtoOACancelOrderReq(pbf, end) {
    return pbf.readFields(readProtoOACancelOrderReqField, {payloadType: 2108, ctidTraderAccountId: 0, orderId: 0}, end);
}
function readProtoOACancelOrderReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
}
export function writeProtoOACancelOrderReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2108) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.orderId) pbf.writeVarintField(3, obj.orderId);
}

export function readProtoOAAmendOrderReq(pbf, end) {
    return pbf.readFields(readProtoOAAmendOrderReqField, {payloadType: 2109, ctidTraderAccountId: 0, orderId: 0, volume: 0, limitPrice: 0, stopPrice: 0, expirationTimestamp: 0, stopLoss: 0, takeProfit: 0, slippageInPoints: 0, relativeStopLoss: 0, relativeTakeProfit: 0, guaranteedStopLoss: false, trailingStopLoss: false, stopTriggerMethod: 1}, end);
}
function readProtoOAAmendOrderReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
...
export function writeProtoOAAmendOrderReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2109) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.orderId) pbf.writeVarintField(3, obj.orderId);
    ...
    if (obj.stopTriggerMethod != null && obj.stopTriggerMethod !== 1) pbf.writeVarintField(15, obj.stopTriggerMethod);
}

export function readProtoOAAmendPositionSLTPReq(pbf, end) {
    return pbf.readFields(readProtoOAAmendPositionSLTPReqField, {payloadType: 2110, ctidTraderAccountId: 0, positionId: 0, stopLoss: 0, takeProfit: 0, guaranteedStopLoss: false, trailingStopLoss: false, stopLossTriggerMethod: 1}, end);
}
function readProtoOAAmendPositionSLTPReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAAmendPositionSLTPReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2110) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    ...
    if (obj.stopLossTriggerMethod != null && obj.stopLossTriggerMethod !== 1) pbf.writeVarintField(9, obj.stopLossTriggerMethod);
}

export function readProtoOAClosePositionReq(pbf, end) {
    return pbf.readFields(readProtoOAClosePositionReqField, {payloadType: 2111, ctidTraderAccountId: 0, positionId: 0, volume: 0}, end);
}
function readProtoOAClosePositionReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
    else if (tag === 4) obj.volume = pbf.readVarint(true);
}
export function writeProtoOAClosePositionReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2111) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.positionId) pbf.writeVarintField(3, obj.positionId);
    if (obj.volume) pbf.writeVarintField(4, obj.volume);
}

export function readProtoOATrailingSLChangedEvent(pbf, end) {
    return pbf.readFields(readProtoOATrailingSLChangedEventField, {payloadType: 2107, ctidTraderAccountId: 0, positionId: 0, orderId: 0, stopPrice: 0, utcLastUpdateTimestamp: 0}, end);
}
function readProtoOATrailingSLChangedEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
...
export function writeProtoOATrailingSLChangedEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2107) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.positionId) pbf.writeVarintField(3, obj.positionId);
    if (obj.orderId) pbf.writeVarintField(4, obj.orderId);
    if (obj.stopPrice) pbf.writeDoubleField(5, obj.stopPrice);
    if (obj.utcLastUpdateTimestamp) pbf.writeVarintField(6, obj.utcLastUpdateTimestamp);
}

export function readProtoOAAssetListReq(pbf, end) {
    return pbf.readFields(readProtoOAAssetListReqField, {payloadType: 2112, ctidTraderAccountId: 0}, end);
}
function readProtoOAAssetListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAssetListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2112) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAAssetListRes(pbf, end) {
    return pbf.readFields(readProtoOAAssetListResField, {payloadType: 2113, ctidTraderAccountId: 0, asset: []}, end);
}
function readProtoOAAssetListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.asset.push(readProtoOAAsset(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAAssetListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2113) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.asset) for (const item of obj.asset) pbf.writeMessage(3, writeProtoOAAsset, item);
}

export function readProtoOASymbolsListReq(pbf, end) {
    return pbf.readFields(readProtoOASymbolsListReqField, {payloadType: 2114, ctidTraderAccountId: 0, includeArchivedSymbols: false}, end);
}
function readProtoOASymbolsListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.includeArchivedSymbols = pbf.readBoolean();
}
export function writeProtoOASymbolsListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2114) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.includeArchivedSymbols) pbf.writeBooleanField(3, obj.includeArchivedSymbols);
}

export function readProtoOASymbolsListRes(pbf, end) {
    return pbf.readFields(readProtoOASymbolsListResField, {payloadType: 2115, ctidTraderAccountId: 0, symbol: [], archivedSymbol: []}, end);
}
function readProtoOASymbolsListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbol.push(readProtoOALightSymbol(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.archivedSymbol.push(readProtoOAArchivedSymbol(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOASymbolsListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2115) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbol) for (const item of obj.symbol) pbf.writeMessage(3, writeProtoOALightSymbol, item);
    if (obj.archivedSymbol) for (const item of obj.archivedSymbol) pbf.writeMessage(4, writeProtoOAArchivedSymbol, item);
}

export function readProtoOASymbolByIdReq(pbf, end) {
    return pbf.readFields(readProtoOASymbolByIdReqField, {payloadType: 2116, ctidTraderAccountId: 0, symbolId: []}, end);
}
function readProtoOASymbolByIdReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOASymbolByIdReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2116) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) for (const item of obj.symbolId) pbf.writeVarintField(3, item);
}

export function readProtoOASymbolByIdRes(pbf, end) {
    return pbf.readFields(readProtoOASymbolByIdResField, {payloadType: 2117, ctidTraderAccountId: 0, symbol: [], archivedSymbol: []}, end);
}
function readProtoOASymbolByIdResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbol.push(readProtoOASymbol(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.archivedSymbol.push(readProtoOAArchivedSymbol(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOASymbolByIdRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2117) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbol) for (const item of obj.symbol) pbf.writeMessage(3, writeProtoOASymbol, item);
    if (obj.archivedSymbol) for (const item of obj.archivedSymbol) pbf.writeMessage(4, writeProtoOAArchivedSymbol, item);
}

export function readProtoOASymbolsForConversionReq(pbf, end) {
    return pbf.readFields(readProtoOASymbolsForConversionReqField, {payloadType: 2118, ctidTraderAccountId: 0, firstAssetId: 0, lastAssetId: 0}, end);
}
function readProtoOASymbolsForConversionReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.firstAssetId = pbf.readVarint(true);
    else if (tag === 4) obj.lastAssetId = pbf.readVarint(true);
}
export function writeProtoOASymbolsForConversionReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2118) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.firstAssetId) pbf.writeVarintField(3, obj.firstAssetId);
    if (obj.lastAssetId) pbf.writeVarintField(4, obj.lastAssetId);
}

export function readProtoOASymbolsForConversionRes(pbf, end) {
    return pbf.readFields(readProtoOASymbolsForConversionResField, {payloadType: 2119, ctidTraderAccountId: 0, symbol: []}, end);
}
function readProtoOASymbolsForConversionResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbol.push(readProtoOALightSymbol(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOASymbolsForConversionRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2119) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbol) for (const item of obj.symbol) pbf.writeMessage(3, writeProtoOALightSymbol, item);
}

export function readProtoOASymbolChangedEvent(pbf, end) {
    return pbf.readFields(readProtoOASymbolChangedEventField, {payloadType: 2120, ctidTraderAccountId: 0, symbolId: []}, end);
}
function readProtoOASymbolChangedEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOASymbolChangedEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2120) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) for (const item of obj.symbolId) pbf.writeVarintField(3, item);
}

export function readProtoOAAssetClassListReq(pbf, end) {
    return pbf.readFields(readProtoOAAssetClassListReqField, {payloadType: 2153, ctidTraderAccountId: 0}, end);
}
function readProtoOAAssetClassListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAssetClassListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2153) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAAssetClassListRes(pbf, end) {
    return pbf.readFields(readProtoOAAssetClassListResField, {payloadType: 2154, ctidTraderAccountId: 0, assetClass: []}, end);
}
function readProtoOAAssetClassListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.assetClass.push(readProtoOAAssetClass(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAAssetClassListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2154) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.assetClass) for (const item of obj.assetClass) pbf.writeMessage(3, writeProtoOAAssetClass, item);
}

export function readProtoOATraderReq(pbf, end) {
    return pbf.readFields(readProtoOATraderReqField, {payloadType: 2121, ctidTraderAccountId: 0}, end);
}
function readProtoOATraderReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOATraderReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2121) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOATraderRes(pbf, end) {
    return pbf.readFields(readProtoOATraderResField, {payloadType: 2122, ctidTraderAccountId: 0, trader: undefined}, end);
}
function readProtoOATraderResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.trader = readProtoOATrader(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOATraderRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2122) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.trader) pbf.writeMessage(3, writeProtoOATrader, obj.trader);
}

export function readProtoOATraderUpdatedEvent(pbf, end) {
    return pbf.readFields(readProtoOATraderUpdatedEventField, {payloadType: 2123, ctidTraderAccountId: 0, trader: undefined}, end);
}
function readProtoOATraderUpdatedEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.trader = readProtoOATrader(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOATraderUpdatedEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2123) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.trader) pbf.writeMessage(3, writeProtoOATrader, obj.trader);
}

export function readProtoOAReconcileReq(pbf, end) {
    return pbf.readFields(readProtoOAReconcileReqField, {payloadType: 2124, ctidTraderAccountId: 0, returnProtectionOrders: false}, end);
}
function readProtoOAReconcileReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.returnProtectionOrders = pbf.readBoolean();
}
export function writeProtoOAReconcileReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2124) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.returnProtectionOrders) pbf.writeBooleanField(3, obj.returnProtectionOrders);
}

export function readProtoOAReconcileRes(pbf, end) {
    return pbf.readFields(readProtoOAReconcileResField, {payloadType: 2125, ctidTraderAccountId: 0, position: [], order: []}, end);
}
function readProtoOAReconcileResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.position.push(readProtoOAPosition(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.order.push(readProtoOAOrder(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAReconcileRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2125) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.position) for (const item of obj.position) pbf.writeMessage(3, writeProtoOAPosition, item);
    if (obj.order) for (const item of obj.order) pbf.writeMessage(4, writeProtoOAOrder, item);
}

export function readProtoOAOrderErrorEvent(pbf, end) {
    return pbf.readFields(readProtoOAOrderErrorEventField, {payloadType: 2132, ctidTraderAccountId: 0, errorCode: "", orderId: 0, positionId: 0, description: ""}, end);
}
function readProtoOAOrderErrorEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
...
export function writeProtoOAOrderErrorEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2132) pbf.writeVarintField(1, obj.payloadType);
...
export function readProtoOADealListReq(pbf, end) {
    return pbf.readFields(readProtoOADealListReqField, {payloadType: 2133, ctidTraderAccountId: 0, fromTimestamp: 0, toTimestamp: 0, maxRows: 0}, end);
}
function readProtoOADealListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOADealListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2133) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
...
export function readProtoOADealListRes(pbf, end) {
    return pbf.readFields(readProtoOADealListResField, {payloadType: 2134, ctidTraderAccountId: 0, deal: [], hasMore: false}, end);
}
function readProtoOADealListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.deal.push(readProtoOADeal(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOADealListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2134) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.deal) for (const item of obj.deal) pbf.writeMessage(3, writeProtoOADeal, item);
    if (obj.hasMore) pbf.writeBooleanField(4, obj.hasMore);
}

export function readProtoOAOrderListReq(pbf, end) {
    return pbf.readFields(readProtoOAOrderListReqField, {payloadType: 2175, ctidTraderAccountId: 0, fromTimestamp: 0, toTimestamp: 0}, end);
}
function readProtoOAOrderListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.fromTimestamp = pbf.readVarint(true);
    else if (tag === 4) obj.toTimestamp = pbf.readVarint(true);
}
export function writeProtoOAOrderListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2175) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.fromTimestamp) pbf.writeVarintField(3, obj.fromTimestamp);
    if (obj.toTimestamp) pbf.writeVarintField(4, obj.toTimestamp);
}

export function readProtoOAOrderListRes(pbf, end) {
    return pbf.readFields(readProtoOAOrderListResField, {payloadType: 2176, ctidTraderAccountId: 0, order: [], hasMore: false}, end);
}
function readProtoOAOrderListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.order.push(readProtoOAOrder(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOAOrderListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2176) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.order) for (const item of obj.order) pbf.writeMessage(3, writeProtoOAOrder, item);
    if (obj.hasMore) pbf.writeBooleanField(4, obj.hasMore);
}

export function readProtoOAExpectedMarginReq(pbf, end) {
    return pbf.readFields(readProtoOAExpectedMarginReqField, {payloadType: 2139, ctidTraderAccountId: 0, symbolId: 0, volume: []}, end);
}
function readProtoOAExpectedMarginReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbolId = pbf.readVarint(true);
    else if (tag === 4) pbf.readPackedVarint(obj.volume, true);
}
export function writeProtoOAExpectedMarginReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2139) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) pbf.writeVarintField(3, obj.symbolId);
    if (obj.volume) for (const item of obj.volume) pbf.writeVarintField(4, item);
}

export function readProtoOAExpectedMarginRes(pbf, end) {
    return pbf.readFields(readProtoOAExpectedMarginResField, {payloadType: 2140, ctidTraderAccountId: 0, margin: [], moneyDigits: 0}, end);
}
function readProtoOAExpectedMarginResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.margin.push(readProtoOAExpectedMargin(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.moneyDigits = pbf.readVarint();
}
export function writeProtoOAExpectedMarginRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2140) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.margin) for (const item of obj.margin) pbf.writeMessage(3, writeProtoOAExpectedMargin, item);
    if (obj.moneyDigits) pbf.writeVarintField(4, obj.moneyDigits);
}

export function readProtoOAMarginChangedEvent(pbf, end) {
    return pbf.readFields(readProtoOAMarginChangedEventField, {payloadType: 2141, ctidTraderAccountId: 0, positionId: 0, usedMargin: 0, moneyDigits: 0}, end);
}
function readProtoOAMarginChangedEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAMarginChangedEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2141) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.positionId) pbf.writeVarintField(3, obj.positionId);
...
export function readProtoOACashFlowHistoryListReq(pbf, end) {
    return pbf.readFields(readProtoOACashFlowHistoryListReqField, {payloadType: 2143, ctidTraderAccountId: 0, fromTimestamp: 0, toTimestamp: 0}, end);
}
function readProtoOACashFlowHistoryListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.fromTimestamp = pbf.readVarint(true);
    else if (tag === 4) obj.toTimestamp = pbf.readVarint(true);
}
export function writeProtoOACashFlowHistoryListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2143) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.fromTimestamp) pbf.writeVarintField(3, obj.fromTimestamp);
    if (obj.toTimestamp) pbf.writeVarintField(4, obj.toTimestamp);
}

export function readProtoOACashFlowHistoryListRes(pbf, end) {
    return pbf.readFields(readProtoOACashFlowHistoryListResField, {payloadType: 2144, ctidTraderAccountId: 0, depositWithdraw: []}, end);
}
function readProtoOACashFlowHistoryListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.depositWithdraw.push(readProtoOADepositWithdraw(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOACashFlowHistoryListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2144) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.depositWithdraw) for (const item of obj.depositWithdraw) pbf.writeMessage(3, writeProtoOADepositWithdraw, item);
}

export function readProtoOAGetAccountListByAccessTokenReq(pbf, end) {
    return pbf.readFields(readProtoOAGetAccountListByAccessTokenReqField, {payloadType: 2149, accessToken: ""}, end);
}
function readProtoOAGetAccountListByAccessTokenReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
}
export function writeProtoOAGetAccountListByAccessTokenReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2149) pbf.writeVarintField(1, obj.payloadType);
    if (obj.accessToken) pbf.writeStringField(2, obj.accessToken);
}

export function readProtoOAGetAccountListByAccessTokenRes(pbf, end) {
    return pbf.readFields(readProtoOAGetAccountListByAccessTokenResField, {payloadType: 2150, accessToken: "", permissionScope: 0, ctidTraderAccount: []}, end);
}
function readProtoOAGetAccountListByAccessTokenResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
    else if (tag === 3) obj.permissionScope = pbf.readVarint();
    else if (tag === 4) obj.ctidTraderAccount.push(readProtoOACtidTraderAccount(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAGetAccountListByAccessTokenRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2150) pbf.writeVarintField(1, obj.payloadType);
    if (obj.accessToken) pbf.writeStringField(2, obj.accessToken);
    if (obj.permissionScope) pbf.writeVarintField(3, obj.permissionScope);
    if (obj.ctidTraderAccount) for (const item of obj.ctidTraderAccount) pbf.writeMessage(4, writeProtoOACtidTraderAccount, item);
}

export function readProtoOARefreshTokenReq(pbf, end) {
    return pbf.readFields(readProtoOARefreshTokenReqField, {payloadType: 2173, refreshToken: ""}, end);
}
function readProtoOARefreshTokenReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.refreshToken = pbf.readString();
}
export function writeProtoOARefreshTokenReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2173) pbf.writeVarintField(1, obj.payloadType);
    if (obj.refreshToken) pbf.writeStringField(2, obj.refreshToken);
}

export function readProtoOARefreshTokenRes(pbf, end) {
    return pbf.readFields(readProtoOARefreshTokenResField, {payloadType: 2174, accessToken: "", tokenType: "", expiresIn: 0, refreshToken: ""}, end);
}
function readProtoOARefreshTokenResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
...
export function writeProtoOARefreshTokenRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2174) pbf.writeVarintField(1, obj.payloadType);
    if (obj.accessToken) pbf.writeStringField(2, obj.accessToken);
...
export function readProtoOASubscribeSpotsReq(pbf, end) {
    return pbf.readFields(readProtoOASubscribeSpotsReqField, {payloadType: 2127, ctidTraderAccountId: 0, symbolId: [], subscribeToSpotTimestamp: false}, end);
}
function readProtoOASubscribeSpotsReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
    else if (tag === 4) obj.subscribeToSpotTimestamp = pbf.readBoolean();
}
export function writeProtoOASubscribeSpotsReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2127) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) for (const item of obj.symbolId) pbf.writeVarintField(3, item);
    if (obj.subscribeToSpotTimestamp) pbf.writeBooleanField(4, obj.subscribeToSpotTimestamp);
}

export function readProtoOASubscribeSpotsRes(pbf, end) {
    return pbf.readFields(readProtoOASubscribeSpotsResField, {payloadType: 2128, ctidTraderAccountId: 0}, end);
}
function readProtoOASubscribeSpotsResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOASubscribeSpotsRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2128) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAUnsubscribeSpotsReq(pbf, end) {
    return pbf.readFields(readProtoOAUnsubscribeSpotsReqField, {payloadType: 2129, ctidTraderAccountId: 0, symbolId: []}, end);
}
function readProtoOAUnsubscribeSpotsReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOAUnsubscribeSpotsReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2129) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) for (const item of obj.symbolId) pbf.writeVarintField(3, item);
}

export function readProtoOAUnsubscribeSpotsRes(pbf, end) {
    return pbf.readFields(readProtoOAUnsubscribeSpotsResField, {payloadType: 2130, ctidTraderAccountId: 0}, end);
}
function readProtoOAUnsubscribeSpotsResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAUnsubscribeSpotsRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2130) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOASpotEvent(pbf, end) {
    return pbf.readFields(readProtoOASpotEventField, {payloadType: 2131, ctidTraderAccountId: 0, symbolId: 0, bid: 0, ask: 0, trendbar: [], sessionClose: 0, timestamp: 0}, end);
}
function readProtoOASpotEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbolId = pbf.readVarint(true);
    else if (tag === 4) obj.bid = pbf.readVarint();
    else if (tag === 5) obj.ask = pbf.readVarint();
    else if (tag === 6) obj.trendbar.push(readProtoOATrendbar(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 7) obj.sessionClose = pbf.readVarint();
    else if (tag === 8) obj.timestamp = pbf.readVarint(true);
}
export function writeProtoOASpotEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2131) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) pbf.writeVarintField(3, obj.symbolId);
    if (obj.bid) pbf.writeVarintField(4, obj.bid);
    if (obj.ask) pbf.writeVarintField(5, obj.ask);
    if (obj.trendbar) for (const item of obj.trendbar) pbf.writeMessage(6, writeProtoOATrendbar, item);
    if (obj.sessionClose) pbf.writeVarintField(7, obj.sessionClose);
    if (obj.timestamp) pbf.writeVarintField(8, obj.timestamp);
}

export function readProtoOASubscribeLiveTrendbarReq(pbf, end) {
    return pbf.readFields(readProtoOASubscribeLiveTrendbarReqField, {payloadType: 2135, ctidTraderAccountId: 0, period: 0, symbolId: 0}, end);
}
function readProtoOASubscribeLiveTrendbarReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.period = pbf.readVarint();
    else if (tag === 4) obj.symbolId = pbf.readVarint(true);
}
export function writeProtoOASubscribeLiveTrendbarReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2135) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.period) pbf.writeVarintField(3, obj.period);
    if (obj.symbolId) pbf.writeVarintField(4, obj.symbolId);
}

export function readProtoOASubscribeLiveTrendbarRes(pbf, end) {
    return pbf.readFields(readProtoOASubscribeLiveTrendbarResField, {payloadType: 2165, ctidTraderAccountId: 0}, end);
}
function readProtoOASubscribeLiveTrendbarResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOASubscribeLiveTrendbarRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2165) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAUnsubscribeLiveTrendbarReq(pbf, end) {
    return pbf.readFields(readProtoOAUnsubscribeLiveTrendbarReqField, {payloadType: 2136, ctidTraderAccountId: 0, period: 0, symbolId: 0}, end);
}
function readProtoOAUnsubscribeLiveTrendbarReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.period = pbf.readVarint();
    else if (tag === 4) obj.symbolId = pbf.readVarint(true);
}
export function writeProtoOAUnsubscribeLiveTrendbarReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2136) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.period) pbf.writeVarintField(3, obj.period);
    if (obj.symbolId) pbf.writeVarintField(4, obj.symbolId);
}

export function readProtoOAUnsubscribeLiveTrendbarRes(pbf, end) {
    return pbf.readFields(readProtoOAUnsubscribeLiveTrendbarResField, {payloadType: 2166, ctidTraderAccountId: 0}, end);
}
function readProtoOAUnsubscribeLiveTrendbarResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAUnsubscribeLiveTrendbarRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2166) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAGetTrendbarsReq(pbf, end) {
    return pbf.readFields(readProtoOAGetTrendbarsReqField, {payloadType: 2137, ctidTraderAccountId: 0, fromTimestamp: 0, toTimestamp: 0, period: 0, symbolId: 0, count: 0}, end);
}
function readProtoOAGetTrendbarsReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.fromTimestamp = pbf.readVarint(true);
    else if (tag === 4) obj.toTimestamp = pbf.readVarint(true);
...
export function writeProtoOAGetTrendbarsReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2137) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.fromTimestamp) pbf.writeVarintField(3, obj.fromTimestamp);
    if (obj.toTimestamp) pbf.writeVarintField(4, obj.toTimestamp);
...
export function readProtoOAGetTrendbarsRes(pbf, end) {
    return pbf.readFields(readProtoOAGetTrendbarsResField, {payloadType: 2138, ctidTraderAccountId: 0, period: 0, timestamp: 0, trendbar: [], symbolId: 0, hasMore: false}, end);
}
function readProtoOAGetTrendbarsResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.period = pbf.readVarint();
    else if (tag === 4) obj.timestamp = pbf.readVarint(true);
    else if (tag === 5) obj.trendbar.push(readProtoOATrendbar(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 6) obj.symbolId = pbf.readVarint(true);
    else if (tag === 7) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOAGetTrendbarsRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2138) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.period) pbf.writeVarintField(3, obj.period);
    if (obj.timestamp) pbf.writeVarintField(4, obj.timestamp);
    if (obj.trendbar) for (const item of obj.trendbar) pbf.writeMessage(5, writeProtoOATrendbar, item);
    if (obj.symbolId) pbf.writeVarintField(6, obj.symbolId);
    if (obj.hasMore) pbf.writeBooleanField(7, obj.hasMore);
}

export function readProtoOAGetTickDataReq(pbf, end) {
    return pbf.readFields(readProtoOAGetTickDataReqField, {payloadType: 2145, ctidTraderAccountId: 0, symbolId: 0, type: 0, fromTimestamp: 0, toTimestamp: 0}, end);
}
function readProtoOAGetTickDataReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbolId = pbf.readVarint(true);
...
export function writeProtoOAGetTickDataReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2145) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) pbf.writeVarintField(3, obj.symbolId);
...
export function readProtoOAGetTickDataRes(pbf, end) {
    return pbf.readFields(readProtoOAGetTickDataResField, {payloadType: 2146, ctidTraderAccountId: 0, tickData: [], hasMore: false}, end);
}
function readProtoOAGetTickDataResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.tickData.push(readProtoOATickData(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOAGetTickDataRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2146) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.tickData) for (const item of obj.tickData) pbf.writeMessage(3, writeProtoOATickData, item);
    if (obj.hasMore) pbf.writeBooleanField(4, obj.hasMore);
}

export function readProtoOAGetCtidProfileByTokenReq(pbf, end) {
    return pbf.readFields(readProtoOAGetCtidProfileByTokenReqField, {payloadType: 2151, accessToken: ""}, end);
}
function readProtoOAGetCtidProfileByTokenReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
}
export function writeProtoOAGetCtidProfileByTokenReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2151) pbf.writeVarintField(1, obj.payloadType);
    if (obj.accessToken) pbf.writeStringField(2, obj.accessToken);
}

export function readProtoOAGetCtidProfileByTokenRes(pbf, end) {
    return pbf.readFields(readProtoOAGetCtidProfileByTokenResField, {payloadType: 2152, profile: undefined}, end);
}
function readProtoOAGetCtidProfileByTokenResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.profile = readProtoOACtidProfile(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOAGetCtidProfileByTokenRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2152) pbf.writeVarintField(1, obj.payloadType);
    if (obj.profile) pbf.writeMessage(2, writeProtoOACtidProfile, obj.profile);
}

export function readProtoOADepthEvent(pbf, end) {
    return pbf.readFields(readProtoOADepthEventField, {payloadType: 2155, ctidTraderAccountId: 0, symbolId: 0, newQuotes: [], deletedQuotes: []}, end);
}
function readProtoOADepthEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbolId = pbf.readVarint();
    else if (tag === 4) obj.newQuotes.push(readProtoOADepthQuote(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 5) pbf.readPackedVarint(obj.deletedQuotes);
}
export function writeProtoOADepthEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2155) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) pbf.writeVarintField(3, obj.symbolId);
    if (obj.newQuotes) for (const item of obj.newQuotes) pbf.writeMessage(4, writeProtoOADepthQuote, item);
    if (obj.deletedQuotes) pbf.writePackedVarint(5, obj.deletedQuotes);
}

export function readProtoOASubscribeDepthQuotesReq(pbf, end) {
    return pbf.readFields(readProtoOASubscribeDepthQuotesReqField, {payloadType: 2156, ctidTraderAccountId: 0, symbolId: []}, end);
}
function readProtoOASubscribeDepthQuotesReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOASubscribeDepthQuotesReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2156) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) for (const item of obj.symbolId) pbf.writeVarintField(3, item);
}

export function readProtoOASubscribeDepthQuotesRes(pbf, end) {
    return pbf.readFields(readProtoOASubscribeDepthQuotesResField, {payloadType: 2157, ctidTraderAccountId: 0}, end);
}
function readProtoOASubscribeDepthQuotesResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOASubscribeDepthQuotesRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2157) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAUnsubscribeDepthQuotesReq(pbf, end) {
    return pbf.readFields(readProtoOAUnsubscribeDepthQuotesReqField, {payloadType: 2158, ctidTraderAccountId: 0, symbolId: []}, end);
}
function readProtoOAUnsubscribeDepthQuotesReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOAUnsubscribeDepthQuotesReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2158) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolId) for (const item of obj.symbolId) pbf.writeVarintField(3, item);
}

export function readProtoOAUnsubscribeDepthQuotesRes(pbf, end) {
    return pbf.readFields(readProtoOAUnsubscribeDepthQuotesResField, {payloadType: 2159, ctidTraderAccountId: 0}, end);
}
function readProtoOAUnsubscribeDepthQuotesResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAUnsubscribeDepthQuotesRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2159) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOASymbolCategoryListReq(pbf, end) {
    return pbf.readFields(readProtoOASymbolCategoryListReqField, {payloadType: 2160, ctidTraderAccountId: 0}, end);
}
function readProtoOASymbolCategoryListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOASymbolCategoryListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2160) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOASymbolCategoryListRes(pbf, end) {
    return pbf.readFields(readProtoOASymbolCategoryListResField, {payloadType: 2161, ctidTraderAccountId: 0, symbolCategory: []}, end);
}
function readProtoOASymbolCategoryListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbolCategory.push(readProtoOASymbolCategory(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOASymbolCategoryListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2161) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.symbolCategory) for (const item of obj.symbolCategory) pbf.writeMessage(3, writeProtoOASymbolCategory, item);
}

export function readProtoOAAccountLogoutReq(pbf, end) {
    return pbf.readFields(readProtoOAAccountLogoutReqField, {payloadType: 2162, ctidTraderAccountId: 0}, end);
}
function readProtoOAAccountLogoutReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAccountLogoutReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2162) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAAccountLogoutRes(pbf, end) {
    return pbf.readFields(readProtoOAAccountLogoutResField, {payloadType: 2163, ctidTraderAccountId: 0}, end);
}
function readProtoOAAccountLogoutResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAccountLogoutRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2163) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAAccountDisconnectEvent(pbf, end) {
    return pbf.readFields(readProtoOAAccountDisconnectEventField, {payloadType: 2164, ctidTraderAccountId: 0}, end);
}
function readProtoOAAccountDisconnectEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAccountDisconnectEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2164) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAMarginCallListReq(pbf, end) {
    return pbf.readFields(readProtoOAMarginCallListReqField, {payloadType: 2167, ctidTraderAccountId: 0}, end);
}
function readProtoOAMarginCallListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAMarginCallListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2167) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAMarginCallListRes(pbf, end) {
    return pbf.readFields(readProtoOAMarginCallListResField, {payloadType: 2168, marginCall: []}, end);
}
function readProtoOAMarginCallListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.marginCall.push(readProtoOAMarginCall(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAMarginCallListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2168) pbf.writeVarintField(1, obj.payloadType);
    if (obj.marginCall) for (const item of obj.marginCall) pbf.writeMessage(2, writeProtoOAMarginCall, item);
}

export function readProtoOAMarginCallUpdateReq(pbf, end) {
    return pbf.readFields(readProtoOAMarginCallUpdateReqField, {payloadType: 2169, ctidTraderAccountId: 0, marginCall: undefined}, end);
}
function readProtoOAMarginCallUpdateReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.marginCall = readProtoOAMarginCall(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOAMarginCallUpdateReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2169) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.marginCall) pbf.writeMessage(3, writeProtoOAMarginCall, obj.marginCall);
}

export function readProtoOAMarginCallUpdateRes(pbf, end) {
    return pbf.readFields(readProtoOAMarginCallUpdateResField, {payloadType: 2170}, end);
}
function readProtoOAMarginCallUpdateResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
export function writeProtoOAMarginCallUpdateRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2170) pbf.writeVarintField(1, obj.payloadType);
}

export function readProtoOAMarginCallUpdateEvent(pbf, end) {
    return pbf.readFields(readProtoOAMarginCallUpdateEventField, {payloadType: 2171, ctidTraderAccountId: 0, marginCall: undefined}, end);
}
function readProtoOAMarginCallUpdateEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.marginCall = readProtoOAMarginCall(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOAMarginCallUpdateEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2171) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.marginCall) pbf.writeMessage(3, writeProtoOAMarginCall, obj.marginCall);
}

export function readProtoOAMarginCallTriggerEvent(pbf, end) {
    return pbf.readFields(readProtoOAMarginCallTriggerEventField, {payloadType: 2172, ctidTraderAccountId: 0, marginCall: undefined}, end);
}
function readProtoOAMarginCallTriggerEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.marginCall = readProtoOAMarginCall(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOAMarginCallTriggerEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2172) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.marginCall) pbf.writeMessage(3, writeProtoOAMarginCall, obj.marginCall);
}

export function readProtoOAGetDynamicLeverageByIDReq(pbf, end) {
    return pbf.readFields(readProtoOAGetDynamicLeverageByIDReqField, {payloadType: 2177, ctidTraderAccountId: 0, leverageId: 0}, end);
}
function readProtoOAGetDynamicLeverageByIDReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.leverageId = pbf.readVarint(true);
}
export function writeProtoOAGetDynamicLeverageByIDReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2177) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.leverageId) pbf.writeVarintField(3, obj.leverageId);
}

export function readProtoOAGetDynamicLeverageByIDRes(pbf, end) {
    return pbf.readFields(readProtoOAGetDynamicLeverageByIDResField, {payloadType: 2178, ctidTraderAccountId: 0, leverage: undefined}, end);
}
function readProtoOAGetDynamicLeverageByIDResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.leverage = readProtoOADynamicLeverage(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOAGetDynamicLeverageByIDRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2178) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.leverage) pbf.writeMessage(3, writeProtoOADynamicLeverage, obj.leverage);
}

export function readProtoOADealListByPositionIdReq(pbf, end) {
    return pbf.readFields(readProtoOADealListByPositionIdReqField, {payloadType: 2179, ctidTraderAccountId: 0, positionId: 0, fromTimestamp: 0, toTimestamp: 0}, end);
}
function readProtoOADealListByPositionIdReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
...
export function writeProtoOADealListByPositionIdReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2179) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.positionId) pbf.writeVarintField(3, obj.positionId);
...
export function readProtoOADealListByPositionIdRes(pbf, end) {
    return pbf.readFields(readProtoOADealListByPositionIdResField, {payloadType: 2180, ctidTraderAccountId: 0, deal: [], hasMore: false}, end);
}
function readProtoOADealListByPositionIdResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.deal.push(readProtoOADeal(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOADealListByPositionIdRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2180) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.deal) for (const item of obj.deal) pbf.writeMessage(3, writeProtoOADeal, item);
    if (obj.hasMore) pbf.writeBooleanField(4, obj.hasMore);
}

export function readProtoOAOrderDetailsReq(pbf, end) {
    return pbf.readFields(readProtoOAOrderDetailsReqField, {payloadType: 2181, ctidTraderAccountId: 0, orderId: 0}, end);
}
function readProtoOAOrderDetailsReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
}
export function writeProtoOAOrderDetailsReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2181) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.orderId) pbf.writeVarintField(3, obj.orderId);
}

export function readProtoOAOrderDetailsRes(pbf, end) {
    return pbf.readFields(readProtoOAOrderDetailsResField, {payloadType: 2182, ctidTraderAccountId: 0, order: undefined, deal: []}, end);
}
function readProtoOAOrderDetailsResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.order = readProtoOAOrder(pbf, pbf.readVarint() + pbf.pos);
    else if (tag === 4) obj.deal.push(readProtoOADeal(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAOrderDetailsRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2182) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.order) pbf.writeMessage(3, writeProtoOAOrder, obj.order);
    if (obj.deal) for (const item of obj.deal) pbf.writeMessage(4, writeProtoOADeal, item);
}

export function readProtoOAOrderListByPositionIdReq(pbf, end) {
    return pbf.readFields(readProtoOAOrderListByPositionIdReqField, {payloadType: 2183, ctidTraderAccountId: 0, positionId: 0, fromTimestamp: 0, toTimestamp: 0}, end);
}
function readProtoOAOrderListByPositionIdReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
    else if (tag === 4) obj.fromTimestamp = pbf.readVarint(true);
...
export function writeProtoOAOrderListByPositionIdReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2183) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.positionId) pbf.writeVarintField(3, obj.positionId);
    if (obj.fromTimestamp) pbf.writeVarintField(4, obj.fromTimestamp);
    if (obj.toTimestamp) pbf.writeVarintField(5, obj.toTimestamp);
...
export function readProtoOAOrderListByPositionIdRes(pbf, end) {
    return pbf.readFields(readProtoOAOrderListByPositionIdResField, {payloadType: 2184, ctidTraderAccountId: 0, order: [], hasMore: false}, end);
}
function readProtoOAOrderListByPositionIdResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.order.push(readProtoOAOrder(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOAOrderListByPositionIdRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2184) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.order) for (const item of obj.order) pbf.writeMessage(3, writeProtoOAOrder, item);
    if (obj.hasMore) pbf.writeBooleanField(4, obj.hasMore);
}

export function readProtoOADealOffsetListReq(pbf, end) {
    return pbf.readFields(readProtoOADealOffsetListReqField, {payloadType: 2185, ctidTraderAccountId: 0, dealId: 0}, end);
}
function readProtoOADealOffsetListReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.dealId = pbf.readVarint(true);
}
export function writeProtoOADealOffsetListReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2185) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.dealId) pbf.writeVarintField(3, obj.dealId);
}

export function readProtoOADealOffsetListRes(pbf, end) {
    return pbf.readFields(readProtoOADealOffsetListResField, {payloadType: 2186, ctidTraderAccountId: 0, offsetBy: [], offsetting: []}, end);
}
function readProtoOADealOffsetListResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.offsetBy.push(readProtoOADealOffset(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.offsetting.push(readProtoOADealOffset(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOADealOffsetListRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2186) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.offsetBy) for (const item of obj.offsetBy) pbf.writeMessage(3, writeProtoOADealOffset, item);
    if (obj.offsetting) for (const item of obj.offsetting) pbf.writeMessage(4, writeProtoOADealOffset, item);
}

export function readProtoOAGetPositionUnrealizedPnLReq(pbf, end) {
    return pbf.readFields(readProtoOAGetPositionUnrealizedPnLReqField, {payloadType: 2187, ctidTraderAccountId: 0}, end);
}
function readProtoOAGetPositionUnrealizedPnLReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAGetPositionUnrealizedPnLReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2187) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAGetPositionUnrealizedPnLRes(pbf, end) {
    return pbf.readFields(readProtoOAGetPositionUnrealizedPnLResField, {payloadType: 2188, ctidTraderAccountId: 0, positionUnrealizedPnL: [], moneyDigits: 0}, end);
}
function readProtoOAGetPositionUnrealizedPnLResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionUnrealizedPnL.push(readProtoOAPositionUnrealizedPnL(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.moneyDigits = pbf.readVarint();
}
export function writeProtoOAGetPositionUnrealizedPnLRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2188) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
    if (obj.positionUnrealizedPnL) for (const item of obj.positionUnrealizedPnL) pbf.writeMessage(3, writeProtoOAPositionUnrealizedPnL, item);
    if (obj.moneyDigits) pbf.writeVarintField(4, obj.moneyDigits);
}

export function readProtoOAv1PnLChangeEvent(pbf, end) {
    return pbf.readFields(readProtoOAv1PnLChangeEventField, {payloadType: 2189, ctidTraderAccountId: 0, grossUnrealizedPnL: 0, netUnrealizedPnL: 0, moneyDigits: 0}, end);
}
function readProtoOAv1PnLChangeEventField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAv1PnLChangeEvent(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2189) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
...
export function readProtoOAv1PnLChangeSubscribeReq(pbf, end) {
    return pbf.readFields(readProtoOAv1PnLChangeSubscribeReqField, {payloadType: 2190, ctidTraderAccountId: 0}, end);
}
function readProtoOAv1PnLChangeSubscribeReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAv1PnLChangeSubscribeReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2190) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAv1PnLChangeSubscribeRes(pbf, end) {
    return pbf.readFields(readProtoOAv1PnLChangeSubscribeResField, {payloadType: 2191, ctidTraderAccountId: 0}, end);
}
function readProtoOAv1PnLChangeSubscribeResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAv1PnLChangeSubscribeRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2191) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAv1PnLChangeUnSubscribeReq(pbf, end) {
    return pbf.readFields(readProtoOAv1PnLChangeUnSubscribeReqField, {payloadType: 2192, ctidTraderAccountId: 0}, end);
}
function readProtoOAv1PnLChangeUnSubscribeReqField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAv1PnLChangeUnSubscribeReq(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2192) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}

export function readProtoOAv1PnLChangeUnSubscribeRes(pbf, end) {
    return pbf.readFields(readProtoOAv1PnLChangeUnSubscribeResField, {payloadType: 2193, ctidTraderAccountId: 0}, end);
}
function readProtoOAv1PnLChangeUnSubscribeResField(tag, obj, pbf) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAv1PnLChangeUnSubscribeRes(obj, pbf) {
    if (obj.payloadType != null && obj.payloadType !== 2193) pbf.writeVarintField(1, obj.payloadType);
    if (obj.ctidTraderAccountId) pbf.writeVarintField(2, obj.ctidTraderAccountId);
}
