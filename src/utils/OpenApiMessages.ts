...
function readProtoOAApplicationAuthReqField(tag: number, obj: ProtoOAApplicationAuthReq, pbf: PBF) {
...
export function writeProtoOAApplicationAuthReq(obj: ProtoOAApplicationAuthReq , pbf: PBF) {
...
function readProtoOAApplicationAuthResField(tag: number, obj: ProtoOAApplicationAuthRes, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
export function writeProtoOAApplicationAuthRes(obj: ProtoOAApplicationAuthRes, pbf: PBF) {
...
function readProtoOAAccountAuthReqField(tag: number, obj: ProtoOAAccountAuthReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.accessToken = pbf.readString();
}
export function writeProtoOAAccountAuthReq(obj: ProtoOAAccountAuthReq, pbf: PBF) {
...
function readProtoOAAccountAuthResField(tag: number, obj: ProtoOAAccountAuthRes, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAccountAuthRes(obj: ProtoOAAccountAuthRes, pbf: PBF) {
...
function readProtoOAClientDisconnectEventField(tag: number, obj: ProtoOAClientDisconnectEvent, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.reason = pbf.readString();
}
export function writeProtoOAClientDisconnectEvent(obj: ProtoOAClientDisconnectEvent, pbf: PBF) {
...
export function readProtoOAAccountsTokenInvalidatedEvent(pbf: PBF, end?: number) {
    return pbf.readFields(readProtoOAAccountsTokenInvalidatedEventField, {payloadType: 2147, ctidTraderAccountIds: [], reason: ""}, end);
}
function readProtoOAAccountsTokenInvalidatedEventField(tag: number, obj: ProtoOAAccountsTokenInvalidatedEvent, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) pbf.readPackedVarint(obj.ctidTraderAccountIds, true);
    else if (tag === 3) obj.reason = pbf.readString();
}
export function writeProtoOAAccountsTokenInvalidatedEvent(obj: ProtoOAAccountsTokenInvalidatedEvent, pbf: PBF) {
...
function readProtoOAVersionReqField(tag: number, obj: ProtoOAVersionReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
...
function readProtoOAVersionResField(tag: number, obj: ProtoOAVersionRes, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
...
function readProtoOANewOrderReqField(tag: number, obj: ProtoOANewOrderReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
function readProtoOAExecutionEventField(tag: number, obj: ProtoOAExecutionEvent, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAExecutionEvent(obj: ProtoOAExecutionEvent, pbf: PBF) {
...
function readProtoOACancelOrderReqField(tag: number, obj: ProtoOACancelOrderReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
}
export function writeProtoOACancelOrderReq(obj: ProtoOACancelOrderReq, pbf: PBF) {
...
function readProtoOAAmendOrderReqField(tag: number, obj: ProtoOAAmendOrderReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
...
function readProtoOAAmendPositionSLTPReqField(tag: number, obj: ProtoOAAmendPositionSLTPReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAAmendPositionSLTPReq(obj: ProtoOAAmendPositionSLTPReq, pbf: PBF) {
...
function readProtoOAClosePositionReqField(tag: number, obj: ProtoOAClosePositionReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
    else if (tag === 4) obj.volume = pbf.readVarint(true);
}
export function writeProtoOAClosePositionReq(obj: ProtoOAClosePositionReq, pbf: PBF) {
...
function readProtoOATrailingSLChangedEventField(tag: number, obj: ProtoOATrailingSLChangedEvent, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
...
export function writeProtoOATrailingSLChangedEvent(obj: ProtoOATrailingSLChangedEvent, pbf: PBF) {
...
function readProtoOAAssetListReqField(tag: number, obj: ProtoOAAssetListReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
...
function readProtoOAAssetListResField(tag: number, obj: ProtoOAAssetListRes, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
function readProtoOASymbolsListReqField(tag: number, obj: ProtoOASymbolsListReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.includeArchivedSymbols = pbf.readBoolean();
}
export function writeProtoOASymbolsListReq(obj: ProtoOASymbolsListReq, pbf: PBF) {
...
function readProtoOASymbolsListResField(tag: number, obj: ProtoOASymbolsListRes, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOASymbolsListRes(obj: ProtoOASymbolsListRes, pbf: PBF) {
...
function readProtoOASymbolByIdReqField(tag: number, obj: ProtoOASymbolByIdReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
function readProtoOASymbolByIdResField(tag: number, obj: ProtoOASymbolByIdRes, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
function readProtoOASymbolsForConversionReqField(tag: number, obj: ProtoOASymbolsForConversionReq, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.firstAssetId = pbf.readVarint(true);
    else if (tag === 4) obj.lastAssetId = pbf.readVarint(true);
}
export function writeProtoOASymbolsForConversionReq(obj: ProtoOASymbolsForConversionReq, pbf: PBF) {
...
function readProtoOASymbolsForConversionResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbol.push(readProtoOALightSymbol(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOASymbolsForConversionRes(obj, pbf: PBF) {
...
function readProtoOASymbolChangedEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOASymbolChangedEvent(obj, pbf: PBF) {
...
function readProtoOAAssetClassListReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAssetClassListReq(obj, pbf: PBF) {
...
function readProtoOATraderReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOATraderReq(obj, pbf: PBF) {
...
function readProtoOATraderResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.trader = readProtoOATrader(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOATraderRes(obj, pbf: PBF) {
...
function readProtoOATraderUpdatedEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.trader = readProtoOATrader(pbf, pbf.readVarint() + pbf.pos);
}
export function writeProtoOATraderUpdatedEvent(obj, pbf: PBF) {
...
function readProtoOAReconcileReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.returnProtectionOrders = pbf.readBoolean();
}
export function writeProtoOAReconcileReq(obj, pbf: PBF) {
...
function readProtoOAReconcileResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAReconcileRes(obj, pbf: PBF) {
...
function readProtoOAOrderErrorEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
...
export function writeProtoOAOrderErrorEvent(obj, pbf: PBF) {
...
function readProtoOADealListReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOADealListReq(obj, pbf: PBF) {
...
function readProtoOAOrderListReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.fromTimestamp = pbf.readVarint(true);
    else if (tag === 4) obj.toTimestamp = pbf.readVarint(true);
}
export function writeProtoOAOrderListReq(obj, pbf: PBF) {
...
function readProtoOAOrderListResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.order.push(readProtoOAOrder(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.hasMore = pbf.readBoolean();
}
export function writeProtoOAOrderListRes(obj, pbf: PBF) {
...
function readProtoOAExpectedMarginReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbolId = pbf.readVarint(true);
    else if (tag === 4) pbf.readPackedVarint(obj.volume, true);
}
export function writeProtoOAExpectedMarginReq(obj, pbf: PBF) {
...
function readProtoOAExpectedMarginResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAExpectedMarginRes(obj, pbf: PBF) {
...
function readProtoOAMarginChangedEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAMarginChangedEvent(obj, pbf: PBF) {
...
function readProtoOACashFlowHistoryListReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.fromTimestamp = pbf.readVarint(true);
    else if (tag === 4) obj.toTimestamp = pbf.readVarint(true);
}
export function writeProtoOACashFlowHistoryListReq(obj, pbf: PBF) {
...
function readProtoOACashFlowHistoryListResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.depositWithdraw.push(readProtoOADepositWithdraw(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOACashFlowHistoryListRes(obj, pbf: PBF) {
...
export function readProtoOAGetAccountListByAccessTokenReq(pbf: PBF, end?: number) {
    return pbf.readFields(readProtoOAGetAccountListByAccessTokenReqField, {payloadType: 2149, accessToken: ""}, end);
}
function readProtoOAGetAccountListByAccessTokenReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
}
export function writeProtoOAGetAccountListByAccessTokenReq(obj, pbf: PBF) {
...
export function readProtoOAGetAccountListByAccessTokenRes(pbf: PBF, end?: number) {
...
function readProtoOAGetAccountListByAccessTokenResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
...
export function writeProtoOAGetAccountListByAccessTokenRes(obj, pbf: PBF) {
...
function readProtoOARefreshTokenReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.refreshToken = pbf.readString();
}
export function writeProtoOARefreshTokenReq(obj, pbf: PBF) {
...
function readProtoOARefreshTokenResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.accessToken = pbf.readString();
...
export function writeProtoOARefreshTokenRes(obj, pbf: PBF) {
...
function readProtoOASubscribeSpotsReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
    else if (tag === 4) obj.subscribeToSpotTimestamp = pbf.readBoolean();
}
export function writeProtoOASubscribeSpotsReq(obj, pbf: PBF) {
...
function readProtoOASubscribeSpotsResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOASubscribeSpotsRes(obj, pbf: PBF) {
...
function readProtoOAUnsubscribeSpotsReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOAUnsubscribeSpotsReq(obj, pbf: PBF) {
...
function readProtoOAUnsubscribeSpotsResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAUnsubscribeSpotsRes(obj, pbf: PBF) {
...
function readProtoOAUnsubscribeLiveTrendbarReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.period = pbf.readVarint();
    else if (tag === 4) obj.symbolId = pbf.readVarint(true);
...
function readProtoOAUnsubscribeLiveTrendbarResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
...
function readProtoOAGetPositionUnrealizedPnLReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
...
function readProtoOAGetPositionUnrealizedPnLResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
