...
function readProtoOAApplicationAuthReqField(tag: number, obj, pbf: PBF) {
...
export function writeProtoOAApplicationAuthReq(obj, pbf: PBF) {
...
function readProtoOAApplicationAuthResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
export function writeProtoOAApplicationAuthRes(obj, pbf: PBF) {
...
function readProtoOAAccountAuthReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.accessToken = pbf.readString();
}
export function writeProtoOAAccountAuthReq(obj, pbf: PBF) {
...
function readProtoOAAccountAuthResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAccountAuthRes(obj, pbf: PBF) {
...
function readProtoOAErrorResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAErrorRes(obj, pbf: PBF) {
...
function readProtoOAClientDisconnectEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.reason = pbf.readString();
}
export function writeProtoOAClientDisconnectEvent(obj, pbf: PBF) {
...
function readProtoOAAccountsTokenInvalidatedEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) pbf.readPackedVarint(obj.ctidTraderAccountIds, true);
    else if (tag === 3) obj.reason = pbf.readString();
}
export function writeProtoOAAccountsTokenInvalidatedEvent(obj, pbf: PBF) {
...
function readProtoOAVersionReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
}
export function writeProtoOAVersionReq(obj, pbf: PBF) {
...
function readProtoOAVersionResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.version = pbf.readString();
}
export function writeProtoOAVersionRes(obj, pbf: PBF) {
...
function readProtoOANewOrderReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOANewOrderReq(obj, pbf: PBF) {
...
function readProtoOAExecutionEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAExecutionEvent(obj, pbf: PBF) {
...
function readProtoOACancelOrderReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
}
export function writeProtoOACancelOrderReq(obj, pbf: PBF) {
...
function readProtoOAAmendOrderReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.orderId = pbf.readVarint(true);
...
export function writeProtoOAAmendOrderReq(obj, pbf: PBF) {
...
function readProtoOAAmendPositionSLTPReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOAAmendPositionSLTPReq(obj, pbf: PBF) {
...
function readProtoOAClosePositionReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
    else if (tag === 4) obj.volume = pbf.readVarint(true);
}
export function writeProtoOAClosePositionReq(obj, pbf: PBF) {
...
function readProtoOATrailingSLChangedEventField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.positionId = pbf.readVarint(true);
...
export function writeProtoOATrailingSLChangedEvent(obj, pbf: PBF) {
...
function readProtoOAAssetListReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
}
export function writeProtoOAAssetListReq(obj, pbf: PBF) {
...
function readProtoOAAssetListResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.asset.push(readProtoOAAsset(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOAAssetListRes(obj, pbf: PBF) {
...
function readProtoOASymbolsListReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.includeArchivedSymbols = pbf.readBoolean();
}
export function writeProtoOASymbolsListReq(obj, pbf: PBF) {
...
function readProtoOASymbolsListResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
...
export function writeProtoOASymbolsListRes(obj, pbf: PBF) {
...
function readProtoOASymbolByIdReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) pbf.readPackedVarint(obj.symbolId, true);
}
export function writeProtoOASymbolByIdReq(obj, pbf: PBF) {
...
function readProtoOASymbolByIdResField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.symbol.push(readProtoOASymbol(pbf, pbf.readVarint() + pbf.pos));
    else if (tag === 4) obj.archivedSymbol.push(readProtoOAArchivedSymbol(pbf, pbf.readVarint() + pbf.pos));
}
export function writeProtoOASymbolByIdRes(obj, pbf: PBF) {
...
function readProtoOASymbolsForConversionReqField(tag: number, obj, pbf: PBF) {
    if (tag === 1) obj.payloadType = pbf.readVarint();
    else if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint(true);
    else if (tag === 3) obj.firstAssetId = pbf.readVarint(true);
    else if (tag === 4) obj.lastAssetId = pbf.readVarint(true);
}
export function writeProtoOASymbolsForConversionReq(obj, pbf: PBF) {
