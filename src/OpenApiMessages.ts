...
private static _readField(tag: number, obj?: ProtoOAApplicationAuthReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.clientId !== undefined && obj.clientId !== null) pbf.writeStringField(2, obj.clientId)
if (obj.clientSecret !== undefined && obj.clientSecret !== null) pbf.writeStringField(3, obj.clientSecret)
}
...
private static _readField(tag: number, obj?: ProtoOAApplicationAuthRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.accessToken !== undefined && obj.accessToken !== null) pbf.writeStringField(3, obj.accessToken)
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.errorCode !== undefined && obj.errorCode !== null) pbf.writeStringField(3, obj.errorCode)
if (obj.description !== undefined && obj.description !== null) pbf.writeStringField(4, obj.description)
if (obj.maintenanceEndTimestamp !== undefined && obj.maintenanceEndTimestamp !== null) pbf.writeVarintField(5, obj.maintenanceEndTimestamp)
if (obj.retryAfter !== undefined && obj.retryAfter !== null) pbf.writeVarintField(6, obj.retryAfter)
}
...
private static _readField(tag: number, obj?: ProtoOAClientDisconnectEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.reason !== undefined && obj.reason !== null) pbf.writeStringField(2, obj.reason)
}
...
private static _readField(tag: number, obj?: ProtoOAAccountsTokenInvalidatedEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
static write(obj: ProtoOAAccountsTokenInvalidatedEvent, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountIds !== undefined && obj.ctidTraderAccountIds !== null) obj.ctidTraderAccountIds.forEach(ctidTraderAccountIds =>pbf.writeVarintField(2, ctidTraderAccountIds))
if (obj.reason !== undefined && obj.reason !== null) pbf.writeStringField(3, obj.reason)
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.version !== undefined && obj.version !== null) pbf.writeStringField(2, obj.version)
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(3, obj.symbolId)
if (obj.orderType !== undefined && obj.orderType !== null) pbf.writeVarintField(4, obj.orderType)
if (obj.tradeSide !== undefined && obj.tradeSide !== null) pbf.writeVarintField(5, obj.tradeSide)
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(6, obj.volume)
if (obj.limitPrice !== undefined && obj.limitPrice !== null) pbf.writeDoubleField(7, obj.limitPrice)
if (obj.stopPrice !== undefined && obj.stopPrice !== null) pbf.writeDoubleField(8, obj.stopPrice)
if (obj.timeInForce !== undefined && obj.timeInForce !== null) pbf.writeVarintField(9, obj.timeInForce)
if (obj.expirationTimestamp !== undefined && obj.expirationTimestamp !== null) pbf.writeVarintField(10, obj.expirationTimestamp)
if (obj.stopLoss !== undefined && obj.stopLoss !== null) pbf.writeDoubleField(11, obj.stopLoss)
if (obj.takeProfit !== undefined && obj.takeProfit !== null) pbf.writeDoubleField(12, obj.takeProfit)
if (obj.comment !== undefined && obj.comment !== null) pbf.writeStringField(13, obj.comment)
if (obj.baseSlippagePrice !== undefined && obj.baseSlippagePrice !== null) pbf.writeDoubleField(14, obj.baseSlippagePrice)
if (obj.slippageInPoints !== undefined && obj.slippageInPoints !== null) pbf.writeVarintField(15, obj.slippageInPoints)
if (obj.label !== undefined && obj.label !== null) pbf.writeStringField(16, obj.label)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(17, obj.positionId)
if (obj.clientOrderId !== undefined && obj.clientOrderId !== null) pbf.writeStringField(18, obj.clientOrderId)
if (obj.relativeStopLoss !== undefined && obj.relativeStopLoss !== null) pbf.writeVarintField(19, obj.relativeStopLoss)
if (obj.relativeTakeProfit !== undefined && obj.relativeTakeProfit !== null) pbf.writeVarintField(20, obj.relativeTakeProfit)
if (obj.guaranteedStopLoss !== undefined && obj.guaranteedStopLoss !== null) pbf.writeBooleanField(21, obj.guaranteedStopLoss)
if (obj.trailingStopLoss !== undefined && obj.trailingStopLoss !== null) pbf.writeBooleanField(22, obj.trailingStopLoss)
if (obj.stopTriggerMethod !== undefined && obj.stopTriggerMethod !== null) pbf.writeVarintField(23, obj.stopTriggerMethod)
}
...
if (tag === 4) obj.position = ProtoOAPositionUtils.read(pbf, pbf.readVarint() + pbf.pos);
if (tag === 5) obj.order = ProtoOAOrderUtils.read(pbf, pbf.readVarint() + pbf.pos);
if (tag === 6) obj.deal = ProtoOADealUtils.read(pbf, pbf.readVarint() + pbf.pos);
if (tag === 7) obj.bonusDepositWithdraw = ProtoOABonusDepositWithdrawUtils.read(pbf, pbf.readVarint() + pbf.pos);
if (tag === 8) obj.depositWithdraw = ProtoOADepositWithdrawUtils.read(pbf, pbf.readVarint() + pbf.pos);
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.executionType !== undefined && obj.executionType !== null) pbf.writeVarintField(3, obj.executionType)
if (obj.position !== undefined && obj.position !== null) pbf.writeMessage(4, ProtoOAPositionUtils.write, obj.position)
if (obj.order !== undefined && obj.order !== null) pbf.writeMessage(5, ProtoOAOrderUtils.write, obj.order)
if (obj.deal !== undefined && obj.deal !== null) pbf.writeMessage(6, ProtoOADealUtils.write, obj.deal)
if (obj.bonusDepositWithdraw !== undefined && obj.bonusDepositWithdraw !== null) pbf.writeMessage(7, ProtoOABonusDepositWithdrawUtils.write, obj.bonusDepositWithdraw)
if (obj.depositWithdraw !== undefined && obj.depositWithdraw !== null) pbf.writeMessage(8, ProtoOADepositWithdrawUtils.write, obj.depositWithdraw)
if (obj.errorCode !== undefined && obj.errorCode !== null) pbf.writeStringField(9, obj.errorCode)
if (obj.isServerEvent !== undefined && obj.isServerEvent !== null) pbf.writeBooleanField(10, obj.isServerEvent)
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.orderId !== undefined && obj.orderId !== null) pbf.writeVarintField(3, obj.orderId)
}
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.orderId !== undefined && obj.orderId !== null) pbf.writeVarintField(3, obj.orderId)
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(4, obj.volume)
if (obj.limitPrice !== undefined && obj.limitPrice !== null) pbf.writeDoubleField(5, obj.limitPrice)
if (obj.stopPrice !== undefined && obj.stopPrice !== null) pbf.writeDoubleField(6, obj.stopPrice)
if (obj.expirationTimestamp !== undefined && obj.expirationTimestamp !== null) pbf.writeVarintField(7, obj.expirationTimestamp)
if (obj.stopLoss !== undefined && obj.stopLoss !== null) pbf.writeDoubleField(8, obj.stopLoss)
if (obj.takeProfit !== undefined && obj.takeProfit !== null) pbf.writeDoubleField(9, obj.takeProfit)
if (obj.slippageInPoints !== undefined && obj.slippageInPoints !== null) pbf.writeVarintField(10, obj.slippageInPoints)
if (obj.relativeStopLoss !== undefined && obj.relativeStopLoss !== null) pbf.writeVarintField(11, obj.relativeStopLoss)
if (obj.relativeTakeProfit !== undefined && obj.relativeTakeProfit !== null) pbf.writeVarintField(12, obj.relativeTakeProfit)
if (obj.guaranteedStopLoss !== undefined && obj.guaranteedStopLoss !== null) pbf.writeBooleanField(13, obj.guaranteedStopLoss)
if (obj.trailingStopLoss !== undefined && obj.trailingStopLoss !== null) pbf.writeBooleanField(14, obj.trailingStopLoss)
if (obj.stopTriggerMethod !== undefined && obj.stopTriggerMethod !== null) pbf.writeVarintField(15, obj.stopTriggerMethod)
}
...
private static _readField(tag: number, obj?: ProtoOAAmendPositionSLTPReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(3, obj.positionId)
if (obj.stopLoss !== undefined && obj.stopLoss !== null) pbf.writeDoubleField(4, obj.stopLoss)
if (obj.takeProfit !== undefined && obj.takeProfit !== null) pbf.writeDoubleField(5, obj.takeProfit)
if (obj.guaranteedStopLoss !== undefined && obj.guaranteedStopLoss !== null) pbf.writeBooleanField(7, obj.guaranteedStopLoss)
if (obj.trailingStopLoss !== undefined && obj.trailingStopLoss !== null) pbf.writeBooleanField(8, obj.trailingStopLoss)
if (obj.stopLossTriggerMethod !== undefined && obj.stopLossTriggerMethod !== null) pbf.writeVarintField(9, obj.stopLossTriggerMethod)
}
...
private static _readField(tag: number, obj?: ProtoOAClosePositionReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOATrailingSLChangedEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(3, obj.positionId)
if (obj.orderId !== undefined && obj.orderId !== null) pbf.writeVarintField(4, obj.orderId)
if (obj.stopPrice !== undefined && obj.stopPrice !== null) pbf.writeDoubleField(5, obj.stopPrice)
if (obj.utcLastUpdateTimestamp !== undefined && obj.utcLastUpdateTimestamp !== null) pbf.writeVarintField(6, obj.utcLastUpdateTimestamp)
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.asset.push(ProtoOAAssetUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOAAssetListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.asset !== undefined && obj.asset !== null) obj.asset.forEach(asset => pbf.writeMessage(3, ProtoOAAssetUtils.write, asset))
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.includeArchivedSymbols !== undefined && obj.includeArchivedSymbols !== null) pbf.writeBooleanField(3, obj.includeArchivedSymbols)
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.symbol.push(ProtoOALightSymbolUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.archivedSymbol.push(ProtoOAArchivedSymbolUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOASymbolsListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbol !== undefined && obj.symbol !== null) obj.symbol.forEach(symbol => pbf.writeMessage(3, ProtoOALightSymbolUtils.write, symbol))
if (obj.archivedSymbol !== undefined && obj.archivedSymbol !== null) obj.archivedSymbol.forEach(archivedSymbol => pbf.writeMessage(4, ProtoOAArchivedSymbolUtils.write, archivedSymbol))
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) obj.symbolId.forEach(symbolId =>pbf.writeVarintField(3, symbolId))
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.symbol.push(ProtoOASymbolUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.archivedSymbol.push(ProtoOAArchivedSymbolUtils.read(pbf, pbf.readVarint() + pbf.pos));
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbol !== undefined && obj.symbol !== null) obj.symbol.forEach(symbol => pbf.writeMessage(3, ProtoOASymbolUtils.write, symbol))
if (obj.archivedSymbol !== undefined && obj.archivedSymbol !== null) obj.archivedSymbol.forEach(archivedSymbol => pbf.writeMessage(4, ProtoOAArchivedSymbolUtils.write, archivedSymbol))
}
...
private static _readField(tag: number, obj?: ProtoOASymbolsForConversionReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.firstAssetId !== undefined && obj.firstAssetId !== null) pbf.writeVarintField(3, obj.firstAssetId)
if (obj.lastAssetId !== undefined && obj.lastAssetId !== null) pbf.writeVarintField(4, obj.lastAssetId)
}
...
private static _readField(tag: number, obj?: ProtoOASymbolsForConversionRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOASymbolChangedEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAAssetClassListReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAAssetClassListRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.assetClass.push(ProtoOAAssetClassUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOAAssetClassListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.assetClass !== undefined && obj.assetClass !== null) obj.assetClass.forEach(assetClass => pbf.writeMessage(3, ProtoOAAssetClassUtils.write, assetClass))
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.trader = ProtoOATraderUtils.read(pbf, pbf.readVarint() + pbf.pos);
}

static write(obj: ProtoOATraderRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.trader !== undefined && obj.trader !== null) pbf.writeMessage(3, ProtoOATraderUtils.write, obj.trader)
}
...
private static _readField(tag: number, obj?: ProtoOATraderUpdatedEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.returnProtectionOrders !== undefined && obj.returnProtectionOrders !== null) pbf.writeBooleanField(3, obj.returnProtectionOrders)
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.position.push(ProtoOAPositionUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.order.push(ProtoOAOrderUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOAReconcileRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.position !== undefined && obj.position !== null) obj.position.forEach(position => pbf.writeMessage(3, ProtoOAPositionUtils.write, position))
if (obj.order !== undefined && obj.order !== null) obj.order.forEach(order => pbf.writeMessage(4, ProtoOAOrderUtils.write, order))
}
...
private static _readField(tag: number, obj?: ProtoOAOrderErrorEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(5, obj.ctidTraderAccountId)
if (obj.errorCode !== undefined && obj.errorCode !== null) pbf.writeStringField(2, obj.errorCode)
if (obj.orderId !== undefined && obj.orderId !== null) pbf.writeVarintField(3, obj.orderId)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(6, obj.positionId)
if (obj.description !== undefined && obj.description !== null) pbf.writeStringField(7, obj.description)
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.fromTimestamp !== undefined && obj.fromTimestamp !== null) pbf.writeVarintField(3, obj.fromTimestamp)
if (obj.toTimestamp !== undefined && obj.toTimestamp !== null) pbf.writeVarintField(4, obj.toTimestamp)
if (obj.maxRows !== undefined && obj.maxRows !== null) pbf.writeVarintField(5, obj.maxRows)
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.deal.push(ProtoOADealUtils.read(pbf, pbf.readVarint() + pbf.pos));
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.deal !== undefined && obj.deal !== null) obj.deal.forEach(deal => pbf.writeMessage(3, ProtoOADealUtils.write, deal))
if (obj.hasMore !== undefined && obj.hasMore !== null) pbf.writeBooleanField(4, obj.hasMore)
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.order.push(ProtoOAOrderUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.hasMore = pbf.readBoolean();
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.order !== undefined && obj.order !== null) obj.order.forEach(order => pbf.writeMessage(3, ProtoOAOrderUtils.write, order))
if (obj.hasMore !== undefined && obj.hasMore !== null) pbf.writeBooleanField(4, obj.hasMore)
}
...
private static _readField(tag: number, obj?: ProtoOAExpectedMarginReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(3, obj.symbolId)
if (obj.volume !== undefined && obj.volume !== null) obj.volume.forEach(volume =>pbf.writeVarintField(4, volume))
}
...
private static _readField(tag: number, obj?: ProtoOAExpectedMarginRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.margin.push(ProtoOAExpectedMarginUtils.read(pbf, pbf.readVarint() + pbf.pos));
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.margin !== undefined && obj.margin !== null) obj.margin.forEach(margin => pbf.writeMessage(3, ProtoOAExpectedMarginUtils.write, margin))
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(4, obj.moneyDigits)
}
...
private static _readField(tag: number, obj?: ProtoOAMarginChangedEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(3, obj.positionId)
if (obj.usedMargin !== undefined && obj.usedMargin !== null) pbf.writeVarintField(4, obj.usedMargin)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(5, obj.moneyDigits)
}
...
private static _readField(tag: number, obj?: ProtoOACashFlowHistoryListReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOACashFlowHistoryListRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.depositWithdraw.push(ProtoOADepositWithdrawUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOACashFlowHistoryListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.depositWithdraw !== undefined && obj.depositWithdraw !== null) obj.depositWithdraw.forEach(depositWithdraw => pbf.writeMessage(3, ProtoOADepositWithdrawUtils.write, depositWithdraw))
}
...
private static _readField(tag: number, obj?: ProtoOAGetAccountListByAccessTokenReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
static write(obj: ProtoOAGetAccountListByAccessTokenReq, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.accessToken !== undefined && obj.accessToken !== null) pbf.writeStringField(2, obj.accessToken)
}
...
private static _readField(tag: number, obj?: ProtoOAGetAccountListByAccessTokenRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (tag === 4) obj.ctidTraderAccount.push(ProtoOACtidTraderAccountUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOAGetAccountListByAccessTokenRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.accessToken !== undefined && obj.accessToken !== null) pbf.writeStringField(2, obj.accessToken)
if (obj.permissionScope !== undefined && obj.permissionScope !== null) pbf.writeVarintField(3, obj.permissionScope)
if (obj.ctidTraderAccount !== undefined && obj.ctidTraderAccount !== null) obj.ctidTraderAccount.forEach(ctidTraderAccount => pbf.writeMessage(4, ProtoOACtidTraderAccountUtils.write, ctidTraderAccount))
}
...
private static _readField(tag: number, obj?: ProtoOARefreshTokenReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.refreshToken !== undefined && obj.refreshToken !== null) pbf.writeStringField(2, obj.refreshToken)
}
...
private static _readField(tag: number, obj?: ProtoOARefreshTokenRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.accessToken !== undefined && obj.accessToken !== null) pbf.writeStringField(2, obj.accessToken)
if (obj.tokenType !== undefined && obj.tokenType !== null) pbf.writeStringField(3, obj.tokenType)
if (obj.expiresIn !== undefined && obj.expiresIn !== null) pbf.writeVarintField(4, obj.expiresIn)
if (obj.refreshToken !== undefined && obj.refreshToken !== null) pbf.writeStringField(5, obj.refreshToken)
}
...
private static _readField(tag: number, obj?: ProtoOASubscribeSpotsReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) obj.symbolId.forEach(symbolId =>pbf.writeVarintField(3, symbolId))
if (obj.subscribeToSpotTimestamp !== undefined && obj.subscribeToSpotTimestamp !== null) pbf.writeBooleanField(4, obj.subscribeToSpotTimestamp)
}
...
private static _readField(tag: number, obj?: ProtoOASubscribeSpotsRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAUnsubscribeSpotsReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAUnsubscribeSpotsRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (tag === 6) obj.trendbar.push(ProtoOATrendbarUtils.read(pbf, pbf.readVarint() + pbf.pos));
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(3, obj.symbolId)
if (obj.bid !== undefined && obj.bid !== null) pbf.writeVarintField(4, obj.bid)
if (obj.ask !== undefined && obj.ask !== null) pbf.writeVarintField(5, obj.ask)
if (obj.trendbar !== undefined && obj.trendbar !== null) obj.trendbar.forEach(trendbar => pbf.writeMessage(6, ProtoOATrendbarUtils.write, trendbar))
if (obj.sessionClose !== undefined && obj.sessionClose !== null) pbf.writeVarintField(7, obj.sessionClose)
if (obj.timestamp !== undefined && obj.timestamp !== null) pbf.writeVarintField(8, obj.timestamp)
}
...
private static _readField(tag: number, obj?: ProtoOASubscribeLiveTrendbarReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.period !== undefined && obj.period !== null) pbf.writeVarintField(3, obj.period)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(4, obj.symbolId)
}
...
private static _readField(tag: number, obj?: ProtoOASubscribeLiveTrendbarRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAUnsubscribeLiveTrendbarReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAUnsubscribeLiveTrendbarRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAGetTrendbarsReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.fromTimestamp !== undefined && obj.fromTimestamp !== null) pbf.writeVarintField(3, obj.fromTimestamp)
if (obj.toTimestamp !== undefined && obj.toTimestamp !== null) pbf.writeVarintField(4, obj.toTimestamp)
if (obj.period !== undefined && obj.period !== null) pbf.writeVarintField(5, obj.period)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(6, obj.symbolId)
if (obj.count !== undefined && obj.count !== null) pbf.writeVarintField(7, obj.count)
}
...
private static _readField(tag: number, obj?: ProtoOAGetTrendbarsRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (tag === 5) obj.trendbar.push(ProtoOATrendbarUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 6) obj.symbolId = pbf.readVarint64();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.period !== undefined && obj.period !== null) pbf.writeVarintField(3, obj.period)
if (obj.timestamp !== undefined && obj.timestamp !== null) pbf.writeVarintField(4, obj.timestamp)
if (obj.trendbar !== undefined && obj.trendbar !== null) obj.trendbar.forEach(trendbar => pbf.writeMessage(5, ProtoOATrendbarUtils.write, trendbar))
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(6, obj.symbolId)
if (obj.hasMore !== undefined && obj.hasMore !== null) pbf.writeBooleanField(7, obj.hasMore)
}
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(3, obj.symbolId)
if (obj.type !== undefined && obj.type !== null) pbf.writeVarintField(4, obj.type)
if (obj.fromTimestamp !== undefined && obj.fromTimestamp !== null) pbf.writeVarintField(5, obj.fromTimestamp)
if (obj.toTimestamp !== undefined && obj.toTimestamp !== null) pbf.writeVarintField(6, obj.toTimestamp)
}
...
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.tickData.push(ProtoOATickDataUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.hasMore = pbf.readBoolean();
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.tickData !== undefined && obj.tickData !== null) obj.tickData.forEach(tickData => pbf.writeMessage(3, ProtoOATickDataUtils.write, tickData))
if (obj.hasMore !== undefined && obj.hasMore !== null) pbf.writeBooleanField(4, obj.hasMore)
}
...
private static _readField(tag: number, obj?: ProtoOAGetCtidProfileByTokenReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAGetCtidProfileByTokenRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.profile = ProtoOACtidProfileUtils.read(pbf, pbf.readVarint() + pbf.pos);
}

static write(obj: ProtoOAGetCtidProfileByTokenRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.profile !== undefined && obj.profile !== null) pbf.writeMessage(2, ProtoOACtidProfileUtils.write, obj.profile)
}
...
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.symbolId = pbf.readVarint64();
if (tag === 4) obj.newQuotes.push(ProtoOADepthQuoteUtils.read(pbf, pbf.readVarint() + pbf.pos));
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(3, obj.symbolId)
if (obj.newQuotes !== undefined && obj.newQuotes !== null) obj.newQuotes.forEach(newQuotes => pbf.writeMessage(4, ProtoOADepthQuoteUtils.write, newQuotes))
if (obj.deletedQuotes !== undefined && obj.deletedQuotes !== null) pbf.writePackedVarint(5, obj.deletedQuotes)
}
...
private static _readField(tag: number, obj?: ProtoOASubscribeDepthQuotesReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOASubscribeDepthQuotesRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAUnsubscribeDepthQuotesReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAUnsubscribeDepthQuotesRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOASymbolCategoryListReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOASymbolCategoryListRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.symbolCategory.push(ProtoOASymbolCategoryUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOASymbolCategoryListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.symbolCategory !== undefined && obj.symbolCategory !== null) obj.symbolCategory.forEach(symbolCategory => pbf.writeMessage(3, ProtoOASymbolCategoryUtils.write, symbolCategory))
}
...
private static _readField(tag: number, obj?: ProtoOAAccountLogoutReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAAccountLogoutRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAAccountDisconnectEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAMarginCallListReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAMarginCallListRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.marginCall.push(ProtoOAMarginCallUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOAMarginCallListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.marginCall !== undefined && obj.marginCall !== null) obj.marginCall.forEach(marginCall => pbf.writeMessage(2, ProtoOAMarginCallUtils.write, marginCall))
}
...
export class ProtoOAMarginCallUpdateReqUtils {
  static read(pbf: PBF, end?: number) {
    return pbf.readFields(
      ...
      {
      ctidTraderAccountId: 0,
      marginCall: {marginCallType: ProtoOANotificationType.MARGIN_LEVEL_THRESHOLD_1, marginLevelThreshold: 0},
      },
      end
    );
  }

private static _readField(tag: number, obj?: ProtoOAMarginCallUpdateReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.marginCall = ProtoOAMarginCallUtils.read(pbf, pbf.readVarint() + pbf.pos);
}

static write(obj: ProtoOAMarginCallUpdateReq, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.marginCall !== undefined && obj.marginCall !== null) pbf.writeMessage(3, ProtoOAMarginCallUtils.write, obj.marginCall)
}
...
private static _readField(tag: number, obj?: ProtoOAMarginCallUpdateRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAMarginCallUpdateEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAMarginCallTriggerEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAGetDynamicLeverageByIDReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.leverageId !== undefined && obj.leverageId !== null) pbf.writeVarintField(3, obj.leverageId)
}
...
export class ProtoOAGetDynamicLeverageByIDResUtils {
  static read(pbf: PBF, end?: number) {
    return pbf.readFields(
      ...
      {
      ctidTraderAccountId: 0,
      leverage: no default value for 'ProtoOADynamicLeverage',
      },
      end
    );
  }

private static _readField(tag: number, obj?: ProtoOAGetDynamicLeverageByIDRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.leverage = ProtoOADynamicLeverageUtils.read(pbf, pbf.readVarint() + pbf.pos);
}

static write(obj: ProtoOAGetDynamicLeverageByIDRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.leverage !== undefined && obj.leverage !== null) pbf.writeMessage(3, ProtoOADynamicLeverageUtils.write, obj.leverage)
}
...
private static _readField(tag: number, obj?: ProtoOADealListByPositionIdReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(3, obj.positionId)
if (obj.fromTimestamp !== undefined && obj.fromTimestamp !== null) pbf.writeVarintField(4, obj.fromTimestamp)
if (obj.toTimestamp !== undefined && obj.toTimestamp !== null) pbf.writeVarintField(5, obj.toTimestamp)
}
...
private static _readField(tag: number, obj?: ProtoOADealListByPositionIdRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAOrderDetailsReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
export class ProtoOAOrderDetailsResUtils {
  static read(pbf: PBF, end?: number) {
    return pbf.readFields(
      ...
      {
      ctidTraderAccountId: 0,
      order: no default value for 'ProtoOAOrder',
      deal: [],
      },
      end
    );
...
private static _readField(tag: number, obj?: ProtoOAOrderDetailsRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.order = ProtoOAOrderUtils.read(pbf, pbf.readVarint() + pbf.pos);
if (tag === 4) obj.deal.push(ProtoOADealUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOAOrderDetailsRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.order !== undefined && obj.order !== null) pbf.writeMessage(3, ProtoOAOrderUtils.write, obj.order)
if (obj.deal !== undefined && obj.deal !== null) obj.deal.forEach(deal => pbf.writeMessage(4, ProtoOADealUtils.write, deal))
}
...
private static _readField(tag: number, obj?: ProtoOAOrderListByPositionIdReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAOrderListByPositionIdRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOADealOffsetListReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.dealId !== undefined && obj.dealId !== null) pbf.writeVarintField(3, obj.dealId)
}
...
private static _readField(tag: number, obj?: ProtoOADealOffsetListRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.offsetBy.push(ProtoOADealOffsetUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.offsetting.push(ProtoOADealOffsetUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOADealOffsetListRes, pbf: PBF = new PBF()) {
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.offsetBy !== undefined && obj.offsetBy !== null) obj.offsetBy.forEach(offsetBy => pbf.writeMessage(3, ProtoOADealOffsetUtils.write, offsetBy))
if (obj.offsetting !== undefined && obj.offsetting !== null) obj.offsetting.forEach(offsetting => pbf.writeMessage(4, ProtoOADealOffsetUtils.write, offsetting))
}
...
private static _readField(tag: number, obj?: ProtoOAGetPositionUnrealizedPnLReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAGetPositionUnrealizedPnLRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
if (tag === 2) obj.ctidTraderAccountId = pbf.readVarint64();
if (tag === 3) obj.positionUnrealizedPnL.push(ProtoOAPositionUnrealizedPnLUtils.read(pbf, pbf.readVarint() + pbf.pos));
if (tag === 4) obj.moneyDigits = pbf.readVarint();
}
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.positionUnrealizedPnL !== undefined && obj.positionUnrealizedPnL !== null) obj.positionUnrealizedPnL.forEach(positionUnrealizedPnL => pbf.writeMessage(3, ProtoOAPositionUnrealizedPnLUtils.write, positionUnrealizedPnL))
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(4, obj.moneyDigits)
}
...
private static _readField(tag: number, obj?: ProtoOAv1PnLChangeEvent, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.payloadType !== undefined && obj.payloadType !== null) pbf.writeVarintField(1, obj.payloadType)
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(2, obj.ctidTraderAccountId)
if (obj.grossUnrealizedPnL !== undefined && obj.grossUnrealizedPnL !== null) pbf.writeVarintField(3, obj.grossUnrealizedPnL)
if (obj.netUnrealizedPnL !== undefined && obj.netUnrealizedPnL !== null) pbf.writeVarintField(4, obj.netUnrealizedPnL)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(5, obj.moneyDigits)
}
...
private static _readField(tag: number, obj?: ProtoOAv1PnLChangeSubscribeReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAv1PnLChangeSubscribeRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAv1PnLChangeUnSubscribeReq, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
private static _readField(tag: number, obj?: ProtoOAv1PnLChangeUnSubscribeRes, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.payloadType = pbf.readVarint();
...
if (obj.assetId !== undefined && obj.assetId !== null) pbf.writeVarintField(1, obj.assetId)
if (obj.name !== undefined && obj.name !== null) pbf.writeStringField(2, obj.name)
if (obj.displayName !== undefined && obj.displayName !== null) pbf.writeStringField(3, obj.displayName)
if (obj.digits !== undefined && obj.digits !== null) pbf.writeVarintField(4, obj.digits)
}
...
if (tag === 13) obj.schedule.push(ProtoOAIntervalUtils.read(pbf, pbf.readVarint() + pbf.pos));
...
if (tag === 33) obj.holiday.push(ProtoOAHolidayUtils.read(pbf, pbf.readVarint() + pbf.pos));
...
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(1, obj.symbolId)
if (obj.digits !== undefined && obj.digits !== null) pbf.writeVarintField(2, obj.digits)
if (obj.pipPosition !== undefined && obj.pipPosition !== null) pbf.writeVarintField(3, obj.pipPosition)
if (obj.enableShortSelling !== undefined && obj.enableShortSelling !== null) pbf.writeBooleanField(4, obj.enableShortSelling)
if (obj.guaranteedStopLoss !== undefined && obj.guaranteedStopLoss !== null) pbf.writeBooleanField(5, obj.guaranteedStopLoss)
if (obj.swapRollover3Days !== undefined && obj.swapRollover3Days !== null) pbf.writeVarintField(6, obj.swapRollover3Days)
if (obj.swapLong !== undefined && obj.swapLong !== null) pbf.writeDoubleField(7, obj.swapLong)
if (obj.swapShort !== undefined && obj.swapShort !== null) pbf.writeDoubleField(8, obj.swapShort)
if (obj.maxVolume !== undefined && obj.maxVolume !== null) pbf.writeVarintField(9, obj.maxVolume)
if (obj.minVolume !== undefined && obj.minVolume !== null) pbf.writeVarintField(10, obj.minVolume)
if (obj.stepVolume !== undefined && obj.stepVolume !== null) pbf.writeVarintField(11, obj.stepVolume)
if (obj.maxExposure !== undefined && obj.maxExposure !== null) pbf.writeVarintField(12, obj.maxExposure)
if (obj.schedule !== undefined && obj.schedule !== null) obj.schedule.forEach(schedule => pbf.writeMessage(13, ProtoOAIntervalUtils.write, schedule))
if (obj.commission !== undefined && obj.commission !== null) pbf.writeVarintField(14, obj.commission)
if (obj.commissionType !== undefined && obj.commissionType !== null) pbf.writeVarintField(15, obj.commissionType)
if (obj.slDistance !== undefined && obj.slDistance !== null) pbf.writeVarintField(16, obj.slDistance)
if (obj.tpDistance !== undefined && obj.tpDistance !== null) pbf.writeVarintField(17, obj.tpDistance)
if (obj.gslDistance !== undefined && obj.gslDistance !== null) pbf.writeVarintField(18, obj.gslDistance)
if (obj.gslCharge !== undefined && obj.gslCharge !== null) pbf.writeVarintField(19, obj.gslCharge)
if (obj.distanceSetIn !== undefined && obj.distanceSetIn !== null) pbf.writeVarintField(20, obj.distanceSetIn)
if (obj.minCommission !== undefined && obj.minCommission !== null) pbf.writeVarintField(21, obj.minCommission)
if (obj.minCommissionType !== undefined && obj.minCommissionType !== null) pbf.writeVarintField(22, obj.minCommissionType)
if (obj.minCommissionAsset !== undefined && obj.minCommissionAsset !== null) pbf.writeStringField(23, obj.minCommissionAsset)
if (obj.rolloverCommission !== undefined && obj.rolloverCommission !== null) pbf.writeVarintField(24, obj.rolloverCommission)
if (obj.skipRolloverDays !== undefined && obj.skipRolloverDays !== null) pbf.writeVarintField(25, obj.skipRolloverDays)
if (obj.scheduleTimeZone !== undefined && obj.scheduleTimeZone !== null) pbf.writeStringField(26, obj.scheduleTimeZone)
if (obj.tradingMode !== undefined && obj.tradingMode !== null) pbf.writeVarintField(27, obj.tradingMode)
if (obj.rolloverCommission3Days !== undefined && obj.rolloverCommission3Days !== null) pbf.writeVarintField(28, obj.rolloverCommission3Days)
if (obj.swapCalculationType !== undefined && obj.swapCalculationType !== null) pbf.writeVarintField(29, obj.swapCalculationType)
if (obj.lotSize !== undefined && obj.lotSize !== null) pbf.writeVarintField(30, obj.lotSize)
if (obj.preciseTradingCommissionRate !== undefined && obj.preciseTradingCommissionRate !== null) pbf.writeVarintField(31, obj.preciseTradingCommissionRate)
if (obj.preciseMinCommission !== undefined && obj.preciseMinCommission !== null) pbf.writeVarintField(32, obj.preciseMinCommission)
if (obj.holiday !== undefined && obj.holiday !== null) obj.holiday.forEach(holiday => pbf.writeMessage(33, ProtoOAHolidayUtils.write, holiday))
if (obj.pnlConversionFeeRate !== undefined && obj.pnlConversionFeeRate !== null) pbf.writeVarintField(34, obj.pnlConversionFeeRate)
if (obj.leverageId !== undefined && obj.leverageId !== null) pbf.writeVarintField(35, obj.leverageId)
if (obj.swapPeriod !== undefined && obj.swapPeriod !== null) pbf.writeVarintField(36, obj.swapPeriod)
if (obj.swapTime !== undefined && obj.swapTime !== null) pbf.writeVarintField(37, obj.swapTime)
if (obj.skipSWAPPeriods !== undefined && obj.skipSWAPPeriods !== null) pbf.writeVarintField(38, obj.skipSWAPPeriods)
if (obj.chargeSwapAtWeekends !== undefined && obj.chargeSwapAtWeekends !== null) pbf.writeBooleanField(39, obj.chargeSwapAtWeekends)
if (obj.measurementUnits !== undefined && obj.measurementUnits !== null) pbf.writeStringField(40, obj.measurementUnits)
}
...
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(1, obj.symbolId)
if (obj.symbolName !== undefined && obj.symbolName !== null) pbf.writeStringField(2, obj.symbolName)
if (obj.enabled !== undefined && obj.enabled !== null) pbf.writeBooleanField(3, obj.enabled)
if (obj.baseAssetId !== undefined && obj.baseAssetId !== null) pbf.writeVarintField(4, obj.baseAssetId)
if (obj.quoteAssetId !== undefined && obj.quoteAssetId !== null) pbf.writeVarintField(5, obj.quoteAssetId)
if (obj.symbolCategoryId !== undefined && obj.symbolCategoryId !== null) pbf.writeVarintField(6, obj.symbolCategoryId)
if (obj.description !== undefined && obj.description !== null) pbf.writeStringField(7, obj.description)
if (obj.sortingNumber !== undefined && obj.sortingNumber !== null) pbf.writeDoubleField(8, obj.sortingNumber)
}
...
private static _readField(tag: number, obj?: ProtoOAArchivedSymbol, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.symbolId = pbf.readVarint64();
...
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(1, obj.symbolId)
if (obj.name !== undefined && obj.name !== null) pbf.writeStringField(2, obj.name)
if (obj.utcLastUpdateTimestamp !== undefined && obj.utcLastUpdateTimestamp !== null) pbf.writeVarintField(3, obj.utcLastUpdateTimestamp)
if (obj.description !== undefined && obj.description !== null) pbf.writeStringField(4, obj.description)
}
...
if (obj.id !== undefined && obj.id !== null) pbf.writeVarintField(1, obj.id)
if (obj.assetClassId !== undefined && obj.assetClassId !== null) pbf.writeVarintField(2, obj.assetClassId)
if (obj.name !== undefined && obj.name !== null) pbf.writeStringField(3, obj.name)
if (obj.sortingNumber !== undefined && obj.sortingNumber !== null) pbf.writeDoubleField(4, obj.sortingNumber)
}
...
if (obj.startSecond !== undefined && obj.startSecond !== null) pbf.writeVarintField(3, obj.startSecond)
if (obj.endSecond !== undefined && obj.endSecond !== null) pbf.writeVarintField(4, obj.endSecond)
}
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(1, obj.ctidTraderAccountId)
if (obj.balance !== undefined && obj.balance !== null) pbf.writeVarintField(2, obj.balance)
if (obj.balanceVersion !== undefined && obj.balanceVersion !== null) pbf.writeVarintField(3, obj.balanceVersion)
if (obj.managerBonus !== undefined && obj.managerBonus !== null) pbf.writeVarintField(4, obj.managerBonus)
if (obj.ibBonus !== undefined && obj.ibBonus !== null) pbf.writeVarintField(5, obj.ibBonus)
if (obj.nonWithdrawableBonus !== undefined && obj.nonWithdrawableBonus !== null) pbf.writeVarintField(6, obj.nonWithdrawableBonus)
if (obj.accessRights !== undefined && obj.accessRights !== null) pbf.writeVarintField(7, obj.accessRights)
if (obj.depositAssetId !== undefined && obj.depositAssetId !== null) pbf.writeVarintField(8, obj.depositAssetId)
if (obj.swapFree !== undefined && obj.swapFree !== null) pbf.writeBooleanField(9, obj.swapFree)
if (obj.leverageInCents !== undefined && obj.leverageInCents !== null) pbf.writeVarintField(10, obj.leverageInCents)
if (obj.totalMarginCalculationType !== undefined && obj.totalMarginCalculationType !== null) pbf.writeVarintField(11, obj.totalMarginCalculationType)
if (obj.maxLeverage !== undefined && obj.maxLeverage !== null) pbf.writeVarintField(12, obj.maxLeverage)
if (obj.frenchRisk !== undefined && obj.frenchRisk !== null) pbf.writeBooleanField(13, obj.frenchRisk)
if (obj.traderLogin !== undefined && obj.traderLogin !== null) pbf.writeVarintField(14, obj.traderLogin)
if (obj.accountType !== undefined && obj.accountType !== null) pbf.writeVarintField(15, obj.accountType)
if (obj.brokerName !== undefined && obj.brokerName !== null) pbf.writeStringField(16, obj.brokerName)
if (obj.registrationTimestamp !== undefined && obj.registrationTimestamp !== null) pbf.writeVarintField(17, obj.registrationTimestamp)
if (obj.isLimitedRisk !== undefined && obj.isLimitedRisk !== null) pbf.writeBooleanField(18, obj.isLimitedRisk)
if (obj.limitedRiskMarginCalculationStrategy !== undefined && obj.limitedRiskMarginCalculationStrategy !== null) pbf.writeVarintField(19, obj.limitedRiskMarginCalculationStrategy)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(20, obj.moneyDigits)
if (obj.fairStopOut !== undefined && obj.fairStopOut !== null) pbf.writeBooleanField(21, obj.fairStopOut)
if (obj.stopOutStrategy !== undefined && obj.stopOutStrategy !== null) pbf.writeVarintField(22, obj.stopOutStrategy)
}
...
if (tag === 2) obj.tradeData = ProtoOATradeDataUtils.read(pbf, pbf.readVarint() + pbf.pos);
...
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(1, obj.positionId)
if (obj.tradeData !== undefined && obj.tradeData !== null) pbf.writeMessage(2, ProtoOATradeDataUtils.write, obj.tradeData)
if (obj.positionStatus !== undefined && obj.positionStatus !== null) pbf.writeVarintField(3, obj.positionStatus)
if (obj.swap !== undefined && obj.swap !== null) pbf.writeVarintField(4, obj.swap)
if (obj.price !== undefined && obj.price !== null) pbf.writeDoubleField(5, obj.price)
if (obj.stopLoss !== undefined && obj.stopLoss !== null) pbf.writeDoubleField(6, obj.stopLoss)
if (obj.takeProfit !== undefined && obj.takeProfit !== null) pbf.writeDoubleField(7, obj.takeProfit)
if (obj.utcLastUpdateTimestamp !== undefined && obj.utcLastUpdateTimestamp !== null) pbf.writeVarintField(8, obj.utcLastUpdateTimestamp)
if (obj.commission !== undefined && obj.commission !== null) pbf.writeVarintField(9, obj.commission)
if (obj.marginRate !== undefined && obj.marginRate !== null) pbf.writeDoubleField(10, obj.marginRate)
if (obj.mirroringCommission !== undefined && obj.mirroringCommission !== null) pbf.writeVarintField(11, obj.mirroringCommission)
if (obj.guaranteedStopLoss !== undefined && obj.guaranteedStopLoss !== null) pbf.writeBooleanField(12, obj.guaranteedStopLoss)
if (obj.usedMargin !== undefined && obj.usedMargin !== null) pbf.writeVarintField(13, obj.usedMargin)
if (obj.stopLossTriggerMethod !== undefined && obj.stopLossTriggerMethod !== null) pbf.writeVarintField(14, obj.stopLossTriggerMethod)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(15, obj.moneyDigits)
if (obj.trailingStopLoss !== undefined && obj.trailingStopLoss !== null) pbf.writeBooleanField(16, obj.trailingStopLoss)
}
...
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(1, obj.symbolId)
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(2, obj.volume)
if (obj.tradeSide !== undefined && obj.tradeSide !== null) pbf.writeVarintField(3, obj.tradeSide)
if (obj.openTimestamp !== undefined && obj.openTimestamp !== null) pbf.writeVarintField(4, obj.openTimestamp)
if (obj.label !== undefined && obj.label !== null) pbf.writeStringField(5, obj.label)
if (obj.guaranteedStopLoss !== undefined && obj.guaranteedStopLoss !== null) pbf.writeBooleanField(6, obj.guaranteedStopLoss)
if (obj.comment !== undefined && obj.comment !== null) pbf.writeStringField(7, obj.comment)
if (obj.measurementUnits !== undefined && obj.measurementUnits !== null) pbf.writeStringField(8, obj.measurementUnits)
if (obj.closeTimestamp !== undefined && obj.closeTimestamp !== null) pbf.writeVarintField(9, obj.closeTimestamp)
}
...
if (obj.orderId !== undefined && obj.orderId !== null) pbf.writeVarintField(1, obj.orderId)
if (obj.tradeData !== undefined && obj.tradeData !== null) pbf.writeMessage(2, ProtoOATradeDataUtils.write, obj.tradeData)
if (obj.orderType !== undefined && obj.orderType !== null) pbf.writeVarintField(3, obj.orderType)
if (obj.orderStatus !== undefined && obj.orderStatus !== null) pbf.writeVarintField(4, obj.orderStatus)
if (obj.expirationTimestamp !== undefined && obj.expirationTimestamp !== null) pbf.writeVarintField(6, obj.expirationTimestamp)
if (obj.executionPrice !== undefined && obj.executionPrice !== null) pbf.writeDoubleField(7, obj.executionPrice)
if (obj.executedVolume !== undefined && obj.executedVolume !== null) pbf.writeVarintField(8, obj.executedVolume)
if (obj.utcLastUpdateTimestamp !== undefined && obj.utcLastUpdateTimestamp !== null) pbf.writeVarintField(9, obj.utcLastUpdateTimestamp)
if (obj.baseSlippagePrice !== undefined && obj.baseSlippagePrice !== null) pbf.writeDoubleField(10, obj.baseSlippagePrice)
if (obj.slippageInPoints !== undefined && obj.slippageInPoints !== null) pbf.writeVarintField(11, obj.slippageInPoints)
if (obj.closingOrder !== undefined && obj.closingOrder !== null) pbf.writeBooleanField(12, obj.closingOrder)
if (obj.limitPrice !== undefined && obj.limitPrice !== null) pbf.writeDoubleField(13, obj.limitPrice)
if (obj.stopPrice !== undefined && obj.stopPrice !== null) pbf.writeDoubleField(14, obj.stopPrice)
if (obj.stopLoss !== undefined && obj.stopLoss !== null) pbf.writeDoubleField(15, obj.stopLoss)
if (obj.takeProfit !== undefined && obj.takeProfit !== null) pbf.writeDoubleField(16, obj.takeProfit)
if (obj.clientOrderId !== undefined && obj.clientOrderId !== null) pbf.writeStringField(17, obj.clientOrderId)
if (obj.timeInForce !== undefined && obj.timeInForce !== null) pbf.writeVarintField(18, obj.timeInForce)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(19, obj.positionId)
if (obj.relativeStopLoss !== undefined && obj.relativeStopLoss !== null) pbf.writeVarintField(20, obj.relativeStopLoss)
if (obj.relativeTakeProfit !== undefined && obj.relativeTakeProfit !== null) pbf.writeVarintField(21, obj.relativeTakeProfit)
if (obj.isStopOut !== undefined && obj.isStopOut !== null) pbf.writeBooleanField(22, obj.isStopOut)
if (obj.trailingStopLoss !== undefined && obj.trailingStopLoss !== null) pbf.writeBooleanField(23, obj.trailingStopLoss)
if (obj.stopTriggerMethod !== undefined && obj.stopTriggerMethod !== null) pbf.writeVarintField(24, obj.stopTriggerMethod)
}
...
private static _readField(tag: number, obj?: ProtoOABonusDepositWithdraw, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
...
if (obj.operationType !== undefined && obj.operationType !== null) pbf.writeVarintField(1, obj.operationType)
if (obj.bonusHistoryId !== undefined && obj.bonusHistoryId !== null) pbf.writeVarintField(2, obj.bonusHistoryId)
if (obj.managerBonus !== undefined && obj.managerBonus !== null) pbf.writeVarintField(3, obj.managerBonus)
if (obj.managerDelta !== undefined && obj.managerDelta !== null) pbf.writeVarintField(4, obj.managerDelta)
if (obj.ibBonus !== undefined && obj.ibBonus !== null) pbf.writeVarintField(5, obj.ibBonus)
if (obj.ibDelta !== undefined && obj.ibDelta !== null) pbf.writeVarintField(6, obj.ibDelta)
if (obj.changeBonusTimestamp !== undefined && obj.changeBonusTimestamp !== null) pbf.writeVarintField(7, obj.changeBonusTimestamp)
if (obj.externalNote !== undefined && obj.externalNote !== null) pbf.writeStringField(8, obj.externalNote)
if (obj.introducingBrokerId !== undefined && obj.introducingBrokerId !== null) pbf.writeVarintField(9, obj.introducingBrokerId)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(10, obj.moneyDigits)
}
...
private static _readField(tag: number, obj?: ProtoOADepositWithdraw, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.operationType = pbf.readVarint();
...
if (obj.operationType !== undefined && obj.operationType !== null) pbf.writeVarintField(1, obj.operationType)
if (obj.balanceHistoryId !== undefined && obj.balanceHistoryId !== null) pbf.writeVarintField(2, obj.balanceHistoryId)
if (obj.balance !== undefined && obj.balance !== null) pbf.writeVarintField(3, obj.balance)
if (obj.delta !== undefined && obj.delta !== null) pbf.writeVarintField(4, obj.delta)
if (obj.changeBalanceTimestamp !== undefined && obj.changeBalanceTimestamp !== null) pbf.writeVarintField(5, obj.changeBalanceTimestamp)
if (obj.externalNote !== undefined && obj.externalNote !== null) pbf.writeStringField(6, obj.externalNote)
if (obj.balanceVersion !== undefined && obj.balanceVersion !== null) pbf.writeVarintField(7, obj.balanceVersion)
if (obj.equity !== undefined && obj.equity !== null) pbf.writeVarintField(8, obj.equity)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(9, obj.moneyDigits)
}
...
if (tag === 16) obj.closePositionDetail = ProtoOAClosePositionDetailUtils.read(pbf, pbf.readVarint() + pbf.pos);
if (tag === 17) obj.moneyDigits = pbf.readVarint();
}

static write(obj: ProtoOADeal, pbf: PBF = new PBF()) {
if (obj.dealId !== undefined && obj.dealId !== null) pbf.writeVarintField(1, obj.dealId)
if (obj.orderId !== undefined && obj.orderId !== null) pbf.writeVarintField(2, obj.orderId)
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(3, obj.positionId)
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(4, obj.volume)
if (obj.filledVolume !== undefined && obj.filledVolume !== null) pbf.writeVarintField(5, obj.filledVolume)
if (obj.symbolId !== undefined && obj.symbolId !== null) pbf.writeVarintField(6, obj.symbolId)
if (obj.createTimestamp !== undefined && obj.createTimestamp !== null) pbf.writeVarintField(7, obj.createTimestamp)
if (obj.executionTimestamp !== undefined && obj.executionTimestamp !== null) pbf.writeVarintField(8, obj.executionTimestamp)
if (obj.utcLastUpdateTimestamp !== undefined && obj.utcLastUpdateTimestamp !== null) pbf.writeVarintField(9, obj.utcLastUpdateTimestamp)
if (obj.executionPrice !== undefined && obj.executionPrice !== null) pbf.writeDoubleField(10, obj.executionPrice)
if (obj.tradeSide !== undefined && obj.tradeSide !== null) pbf.writeVarintField(11, obj.tradeSide)
if (obj.dealStatus !== undefined && obj.dealStatus !== null) pbf.writeVarintField(12, obj.dealStatus)
if (obj.marginRate !== undefined && obj.marginRate !== null) pbf.writeDoubleField(13, obj.marginRate)
if (obj.commission !== undefined && obj.commission !== null) pbf.writeVarintField(14, obj.commission)
if (obj.baseToUsdConversionRate !== undefined && obj.baseToUsdConversionRate !== null) pbf.writeDoubleField(15, obj.baseToUsdConversionRate)
if (obj.closePositionDetail !== undefined && obj.closePositionDetail !== null) pbf.writeMessage(16, ProtoOAClosePositionDetailUtils.write, obj.closePositionDetail)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(17, obj.moneyDigits)
}
...
if (obj.dealId !== undefined && obj.dealId !== null) pbf.writeVarintField(1, obj.dealId)
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(2, obj.volume)
if (obj.executionTimestamp !== undefined && obj.executionTimestamp !== null) pbf.writeVarintField(3, obj.executionTimestamp)
if (obj.executionPrice !== undefined && obj.executionPrice !== null) pbf.writeDoubleField(4, obj.executionPrice)
}
...
private static _readField(tag: number, obj?: ProtoOAClosePositionDetail, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
...
if (obj.entryPrice !== undefined && obj.entryPrice !== null) pbf.writeDoubleField(1, obj.entryPrice)
if (obj.grossProfit !== undefined && obj.grossProfit !== null) pbf.writeVarintField(2, obj.grossProfit)
if (obj.swap !== undefined && obj.swap !== null) pbf.writeVarintField(3, obj.swap)
if (obj.commission !== undefined && obj.commission !== null) pbf.writeVarintField(4, obj.commission)
if (obj.balance !== undefined && obj.balance !== null) pbf.writeVarintField(5, obj.balance)
if (obj.quoteToDepositConversionRate !== undefined && obj.quoteToDepositConversionRate !== null) pbf.writeDoubleField(6, obj.quoteToDepositConversionRate)
if (obj.closedVolume !== undefined && obj.closedVolume !== null) pbf.writeVarintField(7, obj.closedVolume)
if (obj.balanceVersion !== undefined && obj.balanceVersion !== null) pbf.writeVarintField(8, obj.balanceVersion)
if (obj.moneyDigits !== undefined && obj.moneyDigits !== null) pbf.writeVarintField(9, obj.moneyDigits)
if (obj.pnlConversionFee !== undefined && obj.pnlConversionFee !== null) pbf.writeVarintField(10, obj.pnlConversionFee)
}
...
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(3, obj.volume)
if (obj.period !== undefined && obj.period !== null) pbf.writeVarintField(4, obj.period)
if (obj.low !== undefined && obj.low !== null) pbf.writeVarintField(5, obj.low)
if (obj.deltaOpen !== undefined && obj.deltaOpen !== null) pbf.writeVarintField(6, obj.deltaOpen)
if (obj.deltaClose !== undefined && obj.deltaClose !== null) pbf.writeVarintField(7, obj.deltaClose)
if (obj.deltaHigh !== undefined && obj.deltaHigh !== null) pbf.writeVarintField(8, obj.deltaHigh)
if (obj.utcTimestampInMinutes !== undefined && obj.utcTimestampInMinutes !== null) pbf.writeVarintField(9, obj.utcTimestampInMinutes)
}
...
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(1, obj.volume)
if (obj.buyMargin !== undefined && obj.buyMargin !== null) pbf.writeVarintField(2, obj.buyMargin)
if (obj.sellMargin !== undefined && obj.sellMargin !== null) pbf.writeVarintField(3, obj.sellMargin)
}
...
if (obj.timestamp !== undefined && obj.timestamp !== null) pbf.writeVarintField(1, obj.timestamp)
if (obj.tick !== undefined && obj.tick !== null) pbf.writeVarintField(2, obj.tick)
}
...
if (obj.userId !== undefined && obj.userId !== null) pbf.writeVarintField(1, obj.userId)
}
...
private static _readField(tag: number, obj?: ProtoOACtidTraderAccount, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.ctidTraderAccountId = pbf.readVarint64();
...
if (obj.ctidTraderAccountId !== undefined && obj.ctidTraderAccountId !== null) pbf.writeVarintField(1, obj.ctidTraderAccountId)
if (obj.isLive !== undefined && obj.isLive !== null) pbf.writeBooleanField(2, obj.isLive)
if (obj.traderLogin !== undefined && obj.traderLogin !== null) pbf.writeVarintField(3, obj.traderLogin)
if (obj.lastClosingDealTimestamp !== undefined && obj.lastClosingDealTimestamp !== null) pbf.writeVarintField(4, obj.lastClosingDealTimestamp)
if (obj.lastBalanceUpdateTimestamp !== undefined && obj.lastBalanceUpdateTimestamp !== null) pbf.writeVarintField(5, obj.lastBalanceUpdateTimestamp)
if (obj.brokerTitleShort !== undefined && obj.brokerTitleShort !== null) pbf.writeStringField(6, obj.brokerTitleShort)
}
...
if (obj.id !== undefined && obj.id !== null) pbf.writeVarintField(1, obj.id)
if (obj.name !== undefined && obj.name !== null) pbf.writeStringField(2, obj.name)
if (obj.sortingNumber !== undefined && obj.sortingNumber !== null) pbf.writeDoubleField(3, obj.sortingNumber)
}
...
if (obj.id !== undefined && obj.id !== null) pbf.writeVarintField(1, obj.id)
if (obj.size !== undefined && obj.size !== null) pbf.writeVarintField(3, obj.size)
if (obj.bid !== undefined && obj.bid !== null) pbf.writeVarintField(4, obj.bid)
if (obj.ask !== undefined && obj.ask !== null) pbf.writeVarintField(5, obj.ask)
}
...
if (obj.marginCallType !== undefined && obj.marginCallType !== null) pbf.writeVarintField(1, obj.marginCallType)
if (obj.marginLevelThreshold !== undefined && obj.marginLevelThreshold !== null) pbf.writeDoubleField(2, obj.marginLevelThreshold)
if (obj.utcLastUpdateTimestamp !== undefined && obj.utcLastUpdateTimestamp !== null) pbf.writeVarintField(3, obj.utcLastUpdateTimestamp)
}
...
if (obj.holidayId !== undefined && obj.holidayId !== null) pbf.writeVarintField(1, obj.holidayId)
if (obj.name !== undefined && obj.name !== null) pbf.writeStringField(2, obj.name)
if (obj.description !== undefined && obj.description !== null) pbf.writeStringField(3, obj.description)
if (obj.scheduleTimeZone !== undefined && obj.scheduleTimeZone !== null) pbf.writeStringField(4, obj.scheduleTimeZone)
if (obj.holidayDate !== undefined && obj.holidayDate !== null) pbf.writeVarintField(5, obj.holidayDate)
if (obj.isRecurring !== undefined && obj.isRecurring !== null) pbf.writeBooleanField(6, obj.isRecurring)
if (obj.startSecond !== undefined && obj.startSecond !== null) pbf.writeVarintField(7, obj.startSecond)
if (obj.endSecond !== undefined && obj.endSecond !== null) pbf.writeVarintField(8, obj.endSecond)
}
...
private static _readField(tag: number, obj?: ProtoOADynamicLeverage, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.leverageId = pbf.readVarint64();
if (tag === 2) obj.tiers.push(ProtoOADynamicLeverageTierUtils.read(pbf, pbf.readVarint() + pbf.pos));
}

static write(obj: ProtoOADynamicLeverage, pbf: PBF = new PBF()) {
if (obj.leverageId !== undefined && obj.leverageId !== null) pbf.writeVarintField(1, obj.leverageId)
if (obj.tiers !== undefined && obj.tiers !== null) obj.tiers.forEach(tiers => pbf.writeMessage(2, ProtoOADynamicLeverageTierUtils.write, tiers))
}
...
private static _readField(tag: number, obj?: ProtoOADynamicLeverageTier, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.volume = pbf.readVarint64();
...
if (obj.volume !== undefined && obj.volume !== null) pbf.writeVarintField(1, obj.volume)
if (obj.leverage !== undefined && obj.leverage !== null) pbf.writeVarintField(2, obj.leverage)
}
...
private static _readField(tag: number, obj?: ProtoOAPositionUnrealizedPnL, pbf?: PBF) {
if(!obj || !pbf) {
return;
}
if (tag === 1) obj.positionId = pbf.readVarint64();
...
if (obj.positionId !== undefined && obj.positionId !== null) pbf.writeVarintField(1, obj.positionId)
if (obj.grossUnrealizedPnL !== undefined && obj.grossUnrealizedPnL !== null) pbf.writeVarintField(2, obj.grossUnrealizedPnL)
if (obj.netUnrealizedPnL !== undefined && obj.netUnrealizedPnL !== null) pbf.writeVarintField(3, obj.netUnrealizedPnL)
}
